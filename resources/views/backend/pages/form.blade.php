          ...
          <form action="{{route('pages.store')}}" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
             ...
             <!-- ===============================================-->
                  <div class="col-sm-12 col-xl-8">
                                  ...
                                  <div class="row g-6 pt-5">
                                      ...
                                      <div class="col-md-12">
                                          <label class="form-label text-capitalize" for="short_details">
                                              <span>{{_label('banner_short_text')}}</span> </label>
                      ...
                      {{--==========================================--}}
                      {{--===== jquery repeater section start ======--}}
                      @include('backend.components.page-sections-repeater', ['data' => null])
                      {{--===== jquery repeater section end ======--}}
                      {{--==========================================--}}
                             ...
                             <div class="row g-6 pt-5">
                                 <div class="col-md-12">
                                     <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                         ...
                                         <div class="form-check">
                                             <input class="form-check-input" type="checkbox" name="show_trust_bar" id="show_trust_bar" value="1" {{ old('show_trust_bar', '0') == '1' ? 'checked' : '' }}>
    ...
    $(document).ready(function () {
        ...
        $('#page-sections-repeater').repeater({
            ...
            show: function () {
                ...
                // Clean up any cloned TinyMCE markup
