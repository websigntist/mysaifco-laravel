                                        ...
                                        <div class="form-password-toggle">
                                            <label class="form-label text-capitalize" for="meta_description">
                                                {{_label('meta_description')}}
                                                               ...
                                                               placeholder="Write {{_label('meta_description')}}" rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label text-capitalize" for="parent_id">
                                            ...
                                            @foreach($productCategories as $productCat)
                                                <option value="{{ $productCat->id }}" {{ (string) old('parent_id', '0') === (string) $productCat->id ? 'selected' : '' }}>
                                                    {{ ucfirst($productCat->title) }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
