                            ...
                            <div class="card-body">
                                <div class="row g-6 pt-5">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" id="title" name="title" value="{{ old('title') }}" class="form-control" placeholder="Enter title..." required>
                                        {!! error_label('title') !!}
                                    </div>
                                    
                                    <div class="col-md-12 mb-4">
                                        <label class="form-label text-capitalize font-weight-bold" for="editor">Description</label>
                                        <textarea class="form-control" id="editor" name="description" placeholder="Write description..." rows="5">{{ old('description') }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="border rounded p-4 bg-light shadow-xs">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="title1" id="title1" class="form-control" placeholder="Title 1" value="{{ old('title1') }}">
                                            </div>
                                            <div>
                                                <label class="form-label" for="sub_title1">Sub Title 1</label>
                                                <input type="text" name="sub_title1" id="sub_title1" class="form-control" placeholder="Sub Title 1" value="{{ old('sub_title1') }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="border rounded p-4 bg-light shadow-xs">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="title2" id="title2" class="form-control" placeholder="Title 2" value="{{ old('title2') }}">
                                            </div>
                                            <div>
                                                <label class="form-label" for="sub_title2">Sub Title 2</label>
                                                <input type="text" name="sub_title2" id="sub_title2" class="form-control" placeholder="Sub Title 2" value="{{ old('sub_title2') }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="border rounded p-4 bg-light shadow-xs">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="title3" id="title3" class="form-control" placeholder="Title 3" value="{{ old('title3') }}">
                                            </div>
                                            <div>
                                                <label class="form-label" for="sub_title3">Sub Title 3</label>
                                                <input type="text" name="sub_title3" id="sub_title3" class="form-control" placeholder="Sub Title 3" value="{{ old('sub_title3') }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="border rounded p-4 bg-light shadow-xs">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="title4" id="title4" class="form-control" placeholder="Title 4" value="{{ old('title4') }}">
                                            </div>
                                            <div>
                                                <label class="form-label" for="sub_title4">Sub Title 4</label>
                                                <input type="text" name="sub_title4" id="sub_title4" class="form-control" placeholder="Sub Title 4" value="{{ old('sub_title4') }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="border rounded p-4 bg-light shadow-xs">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="title5" id="title5" class="form-control" placeholder="Title 5" value="{{ old('title5') }}">
                                            </div>
                                            <div>
                                                <label class="form-label" for="sub_title5">Sub Title 5</label>
                                                <input type="text" name="sub_title5" id="sub_title5" class="form-control" placeholder="Sub Title 5" value="{{ old('sub_title5') }}">
                                            </div>
                                        </div>
                                    </div>
