...
@push('style')
    <link rel="stylesheet" href="{{ asset('assets/backend/css/apex-charts.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/backend/css/swiper.css') }}">
                      ...
                      <div class="swiper-wrapper">
                            ...
                            <div class="row">
                               ...
                               <div class="row">
                                  ...
                                  <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                                     <img src="{{asset('assets/images/illustrations/card-website-analytics-1.png')}}" alt="Website Analytics" height="150" class="card-website-analytics-img">
                                  </div>
                               </div>
                            </div>
                         </div>
                         <div class="swiper-slide">
                            <div class="row">
                               ...
                               <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                                  <img src="{{asset('assets/images/illustrations/card-website-analytics-2.png') }}" alt="Website Analytics" height="150" class="card-website-analytics-img">
                               </div>
                            </div>
                         </div>
                         <div class="swiper-slide">
                            <div class="row">
                               ...
                               <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                                  <img src="{{asset('assets/images/illustrations/card-website-analytics-3.png')}}" alt="Website Analytics" height="150"
...
@push('script')
    ...
    <script src="{{ asset('assets/backend/js/swiper.js') }}"></script>
