                                                    ...
                                                    <div class="d-flex justify-content-start align-items-center user-name">
                                                        <div class="avatar-wrapper">
                                                            <div class="avatar avatar-md me-4 light-gallery" id="gallery-{{ $data->id }}">
                                                                <a href="{{ asset('assets/images/'.$module .'/'. $data->icon) }}">
                                                                    <img src="{{ $data->icon ? asset('assets/images/' . $module .'/'. $data->icon) : imageNotFound() }}"
                                                                         alt="{{ $data->title }}"
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <small class="text-muted">Ordering: {{ $data->ordering }}</small>
                                                        </div>
                                                    </div>
                                                @elseif($col === 'status')
                ...
                btn.addEventListener("click", async function () {
                    ...
                    try {
                        ...
                        const iconUrl = data.icon
                            ? `/assets/images/{{ $module }}/${data.icon}`
                            : '{{ imageNotFound() }}';
