                                            ...
                                            <td class="capitalize">
                                                ...
                                                @elseif($col === 'status')
                                                    <span id="statusLabel-{{ $data->id }}"
                                                          class="badge {{ $data->status === 'Replied' ? 'bg-label-success' : 'bg-label-danger' }}">{{ ucfirst($data->status) }}
                                                        </span>
            ...
            btn.addEventListener("click", async function () {
                ...
                try {
                    ...
                    let rows = `
                        ...
                        <tr><th>{{ _label('first_name') }}</th><td>${data.first_name ?? '-'}</td></tr>
                        <tr><th>{{ _label('last_name') }}</th><td>${data.last_name ?? '-'}</td></tr>
                        <tr><th>{{ _label('email') }}</th><td>${data.email ?? '-'}</td></tr>
                        <tr><th>{{ _label('phone') }}</th><td>${data.phone ?? '-'}</td></tr>
                        <tr><th>{{ _label('message') }}</th><td>${data.message ?? '-'}</td></tr>
                        <tr>
                            <th>{{ _label('status') }}</th>
                            <td>
