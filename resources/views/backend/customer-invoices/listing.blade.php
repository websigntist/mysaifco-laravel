                                        ...
                                        <tr id="rowId-{{ $data->id }}">
                                            ...
                                            @foreach($columns as $col)
                                                ...
                                                <td class="capitalize">
                                                    @if($col === 'invoice_number')
                                                        <strong class="text-primary">{{ $data->invoice_number }}</strong>
                                                    @elseif($col === 'client_name')
                                                        {{ $data->client_name }}
                                                    @elseif($col === 'client_email')
                                                        {{ $data->client_email }}
                                                    @elseif($col === 'invoice_date' || $col === 'due_date')
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    {{--{!! actionButton2($module, 'view', route($module.'.view', $data->id), null, $data->id, 'View Details') !!}--}}
