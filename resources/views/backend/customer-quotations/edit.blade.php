...
@section('content')
    <div class="container-xxl flex-grow-1 mt-3 -container-p-y">
          <form action="{{route('quotations.update', $getData->id)}}" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
              @csrf
              @method('PUT')
             <div class="row gy-6">
                 <div class="col-sm-12">
                            ...
                            <div class="row g-6 pt-5">
                               <div class="col-md-4">
                                  <label class="form-label text-capitalize" for="quotation_number">
                                      <span>{{_label('quotation_number')}}</span>
                                  </label>
                                  <input type="text"
                                         id="quotation_number"
                                         name="quotation_number"
                                         value="{{ old('quotation_number', $getData->quotation_number) }}"
                                         class="form-control"
                               ...
                               <div class="col-md-6">
                                  <label class="form-label text-capitalize" for="quotation_date">
                                      <span>{{_label('quotation_date')}}</span>
                                  </label>
                                  <input type="date"
                                         id="quotation_date"
                                         name="quotation_date"
                                         value="{{ old('quotation_date', $getData->quotation_date->format('Y-m-d')) }}"
                               ...
                               <div class="col-md-6">
                                  <label class="form-label text-capitalize" for="valid_until">
                                      <span>{{_label('valid_until')}}</span>
                                  </label>
                                  <input type="date"
                                         id="valid_until"
                                         name="valid_until"
                                         value="{{ old('valid_until', $getData->valid_until->format('Y-m-d')) }}"
                                         class="form-control dob-picker"
                                         placeholder="YYYY-MM-DD"
                                         required>
                      ...
                      <div class="collapse show">
                         <div class="card-body">
                            <div id="quotation-items-container">
                                ...
                                <div class="quotation-item border p-3 mb-3 rounded" data-item="{{$index}}">
                               ...
                               <div class="col-md-4">
                                  ...
                                  @if($getData->letterhead)
                                      <div class="mb-2 position-relative d-inline-block" id="letterhead-preview">
                                          <img src="{{ asset('assets/images/quo-assets/' . $getData->letterhead) }}"
                                               alt="Letterhead"
