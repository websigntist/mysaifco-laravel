                                ...
                                <div class="row g-6 pt-5">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('name') }}"
                                               class="form-control"
                                               placeholder="Enter {{_label('brand_name')}}..." required>
                                        {!! error_label('name') !!}
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" id="editor" name="description" rows="4" placeholder="Description">{{ old('description') }}</textarea>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" id="ordering" name="ordering" value="{{ old('ordering', 0) }}" class="form-control" min="0">
                                    </div>
                                    <div class="col-md-4">
