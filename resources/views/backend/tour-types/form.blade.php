                            ...
                            <div class="card-body">
                                <div class="row g-6 pt-5">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <small class="text-muted">Frontend URL: {{ url('/') }}/<span id="friendly_url_preview">{{ old('friendly_url', 'your-slug') }}</span></small>
                                ...
                                <div class="row g-6 pt-5">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control"
                                                  ...
                                                  placeholder="Write {{ _label('meta_description') }}"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select id="show_on_home" name="show_on_home" class="form-select select2" required>
                                            @foreach($showOnHome as $showHome)
                                                <option value="{{ $showHome }}" {{ old('show_on_home', 'No') === $showHome ? 'selected' : '' }}>
                                                    {{ ucfirst($showHome) }}
                                                </option>
                                            @endforeach
                                        </select>
