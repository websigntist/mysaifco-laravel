                                        ...
                                        @foreach($columns as $col)
                                            ...
                                            <td class="capitalize">
                                                ...
                                                @elseif($col === 'categories')
                                                    @forelse($data->blogCategories as $category)
                                                ...
                                                @elseif($col === 'status')
                                                    <span id="statusLabel-{{ $data->id }}"
                                                          class="badge {{ $data->status === 'published' ? 'bg-label-success' : 'bg-label-danger' }}">
                                                                {{ ucfirst($data->status) }}
                                                            </span>
