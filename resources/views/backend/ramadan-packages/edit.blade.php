                                ...
                                <div class="row g-6 pt-5">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text"
                                               id="departure_day"
                                               name="departure_day"
                                               value="{{ old('departure_day', $data->departure_day) }}"
                                               class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text"
                                               id="arrival_day"
                                               name="arrival_day"
                                               value="{{ old('arrival_day', $data->arrival_day) }}"
                                               class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control"
                                                  ...
                                                  rows="5">{{ old('departure_dates', $data->departure_dates) }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control"
                                                  ...
                                                  name="arrival_dates"
                                                  placeholder="09/07/2025&#10;16/07/2025&#10;23/07/2025&#10;30/07/2025"
                                                  rows="5">{{ old('arrival_dates', $data->arrival_dates) }}</textarea>
                                        <small class="text-muted">Enter each date on a new line.</small>
                                    </div>
