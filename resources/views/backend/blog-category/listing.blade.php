                                    ...
                                    <tr id="rowId-{{ $data->id }}">
                                        ...
                                        @foreach($columns as $col)
                                            ...
                                            <td class="capitalize">
                                                ...
                                                @elseif($col === 'menu_title')
                                                    {{ $data->menu_title }}
                                                    {{--<span class="invisible">{{ $data->menu_title }}</span>--}}
                                                    {{--<input type="text"
                                                           id="menu_title"
                                                           name="menu_title"
                                                           data-id="{{ $data->id }}"
                                                           value="{{ $data->menu_title }}"
                                                           class="menu_title form-control">--}}
                                                @elseif($col === 'parent_id')
                                                    @if ($data->parentCategory?->title)
                                                        <span class="badge badge-outline-warning">{{$data->parentCategory?->title}}</span>
                                                    @else
                ...
                `;
                    ...
                    try {
                        ...
                        const rows = `
                            ...
                            <tr><th>{{_label('parent_category')}}</th><td>${data.parent_page_title ?? '/Parent'}</td></tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img
                                        src="${data.image ? `/assets/images/{{$module}}/${data.image}` :
                            imageNotFound()}"
                                        alt="Image"
