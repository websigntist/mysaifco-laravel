                                ...
                                <div class="row g-6 pt-5">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text"
                                               id="title"
                                               name="title"
                                               value="{{ old('title', 'Required Documents for Umrah Visa') }}"
                                               class="form-control"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="subtitle"
                                                  ...
                                                  class="form-control"
                                                  rows="3"
                                                  placeholder="e.g. Please ensure all documents are clear, valid and up to date.">{{ old('subtitle', 'Please ensure all documents are clear, valid and up to date.') }}</textarea>
                                        {!! error_label('subtitle') !!}
                                    </div>

                                    <div class="col-md-12 mt-4">
                                        @include('backend.components.document-items-repeater', ['data' => null])
                                    </div>
                                </div>
                            </div>
                        </div>
