                                ...
                                <div class="row g-6 pt-5">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <select id="parent_id" name="parent_id" class="form-select select2" required>
                                            ...
                                            @foreach($parent_ids as $module)
                                                <option value="{{ $module->id }}" {{$module->id == $data->parent_id ? 'selected' : ''}}>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <input type="text"
                                                id="module_title"
                                                name="module_title"
                                                value="{{ old('module_title', $data->module_title) }}"
                                                class="form-control"
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <input type="text"
                                               id="module_slug"
                                               name="module_slug"
                                               value="{{ old('module_slug', $data->module_slug) }}"
                                               class="form-control"
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        ...
                                        <input type="text"
                                               id="actions"
                                               name="actions"
                                               value="{{ old('actions', $data->actions) }}"
                                               class="form-control"
