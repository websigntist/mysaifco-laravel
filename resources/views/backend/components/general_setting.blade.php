        ...
        <div class="col-md-12">
            <label class="form-label text-capitalize" for="site_keywords">
                <?php echo _label('site_keywords'); ?>
                            ...
                            value="{{old('site_keywords', get_setting('site_keywords'))}}"
                            class="form-control"
        ...
        <div class="col-md-12">
            <div class="form-password-toggle">
                ...
                <textarea class="form-control"
                           ...
                           placeholder="Write <?php echo _label('site_description'); ?>" rows="3">{{old('site_description', get_setting('site_description')) }}</textarea>
            </div>
        </div>
        <!-- site loader -->
        <div class="col-md-12">
            ...
            <select id="site_loader" name="settings[loader]" class="form-select select2">
                ...
                <option value="Yes" {{(get_setting('loader')) == 'Yes' ? 'selected' : ''}}>Yes</option>
                <option value="No" {{(get_setting('loader')) == 'No' ? 'selected' : ''}}>No</option>
            </select>
        </div>
    </div>
</div>
