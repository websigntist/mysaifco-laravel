<footer class="pt-12 px-3 border-t-2 border-t-mst-text">
    <div class="container mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-[3fr_1fr_1fr_1fr_1fr] gap-5">
            <div>
                <a href="{{url('/')}}" class="text-2xl font-bold text-mst-text py-3">
                    <img src="{{asset('assets/images/footer-logo.svg')}}" width="" alt="logo" title="brand logo"> </a>
                <p class="text-sm my-3 text-mst-text leading-6 pe-6">
            ...
            <div class="hidden md:block">
                <div class="text-mst-text text-sm font-semibold mb-3">Services</div>
                <ul class="flex flex-col gap-1 text-mst-text text-sm capitalize space-y-[5px]">
                    <li class="flex">
            ...
            <div class="hidden md:block">
                <div class="heading text-mst-text text-sm font-semibold mb-3">Company</div>
                <ul class="flex flex-col gap-1 text-mst-text text-sm capitalize space-y-[5px]">
                    <li class="flex">
                        <a href="">Home</a></li>
                    <li class="flex">
            ...
            <div class="hidden md:block md:col-span-2">
                <div class="container">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="hidden md:block">
                            <div class="heading text-mst-text text-sm font-semibold mb-3">Legal</div>
                            <ul class="flex flex-col gap-1 text-mst-text text-sm capitalize space-y-[5px]">
                                <li class="flex">
                        ...
                        <div class="hidden md:block">
                            <div class="heading text-mst-text text-sm font-semibold mb-3">Need Help?</div>
                            <ul class="flex flex-col gap-1 text-mst-text text-sm capitalize space-y-[5px]">
                                <li class="flex">
                                    <a href="">FAQs</a></li>
                                <li class="flex">
    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr_1fr] gap-5">
            ...
            <!-- Email -->
            <div class="flex items-center gap-2 text-xs text-body mt-4">
                <img src="{{asset('assets/images/email.svg')}}" class="w-10 shrink-0" alt="email"> <span>info@mysaifco.com</span>
            </div>
            <!-- Address -->
            <div class="flex items-start gap-2 text-xs text-body mt-6">
            ...
            <!-- Phone -->
            <div class="flex items-start gap-2 text-xs text-body mt-4">
