<footer class="pt-12 px-3 border-t-2 border-t-mst-gray">
    <div class="container mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-6 gap-5">
            ...
            <div class="hidden md:block">
                ...
                <img src="{{asset('assets/images/payment-icons.png')}}" class="w-60 mt-6" alt="payment-icons">
            </div>
    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-[2.1fr_1fr_1fr_1fr] gap-5">
            <div>
            ...
            <!-- Email -->
            <div class="flex items-center gap-5 text-xs text-body md:mt-10">
                <img src="{{asset('assets/images/email.svg')}}" class="w-10 shrink-0" alt="email"> <span>info@mysaifco.com</span>
            </div>
            <!-- Address -->
            <div class="flex items-start gap-3 text-xs text-body  md:mt-12">
                <img src="{{asset('assets/images/location.svg')}}" class="w-10 shrink-0 mt-0.5" alt="address">
                <span>16th Street Shop # 5, Bohra Masjid <br> Road, Ayal Nasir, Deira, Dubai, UAE</span>
            </div>
            <!-- Phone -->
            <div class="flex items-start gap-3 text-xs text-body md:mt-10">
