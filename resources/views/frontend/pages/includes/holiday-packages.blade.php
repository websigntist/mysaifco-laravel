<section class="">
    <div class="px-4 relative flex w-full items-start justify-center overflow-hidden">
        <div class="absolute inset-0 scale-100 bg-cover bg-top bg-no-repeat" style="background-image: url('{{ asset('assets/images/pages/1784011979_6a55dccb9d9fb_image.webp') }}')" aria-hidden="true"></div>
        {{--@dump($explore_uae)--}}
...
{{-- ===== Find your Perfect Holiday (search bar) ===== --}}
<section class="pt-12">
    <div class="container mx-auto">
            ...
            @foreach($packages as $package)
                <article class="bg-white border border-gray-200 rounded-2xl overflow-hidden flex flex-col">
                    ...
                    <div class="p-5 flex flex-col flex-1">
                        <h3 class="font-heading font-bold text-2xl text-mst-gray">{{ $package['name'] }}</h3>
                        <p class="font-body text-sm text-gray-600 mt-2">{{ $package['duration'] }}</p>
                        <div class="flex items-end justify-between mt-4">
                            <div>
                                <p class="font-body text-sm text-gray-600">Starting</p>
                                <p class="font-heading font-bold text-lg text-mst-gray">AED {{ $package['price'] }}<span class="font-body font-normal text-sm text-gray-600">/person</span></p>
                            </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            @foreach($categories as $category)
                <a href="#" class="group flex flex-col items-center justify-center text-center gap-3 bg-gray-50 border border-gray-200 rounded-2xl py-8 px-4 transition duration-300 hover:border-mst hover:shadow-sm">
                    <img src="{{ asset('assets/images/icons/' . $category['emoji']) }}" alt="">
                    <span class="font-heading italic font-bold text-mst-gray group-hover:text-mst transition">{{ $category['label'] }}</span>
                </a>
            @endforeach
        </div>
    </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            @foreach($reasons as $reason)
                <div class="flex flex-col items-center justify-center text-center gap-2 bg-gray-50 border border-gray-200 rounded-2xl py-8 px-4">
                    <img src="{{ asset('assets/images/icons/' . $reason['icon']) }}" alt="">
                    <span class="font-heading italic font-bold text-mst-gray mt-1">{{ $reason['title'] }}</span>
                    <span class="font-body text-xs text-gray-600 leading-tight">{{ $reason['sub'] }}</span>
                </div>
            @endforeach
        </div>
    </div>
