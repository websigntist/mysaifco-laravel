    ...
    <div class="container mx-auto text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mt-10">
            <div class="bg-[linear-gradient(to_bottom_left,#f3f4f6_60%,#eeeeee_50%)] p-10 rounded shadow-md hover:shadow-lg transition duration-300 ease-in-out shadow-gray-300
                ...
                <a href="">
                    <img src="{{asset('assets/images/product-category/01.webp')}}" class="mx-auto transition-transform duration-500 hover:scale-101" alt="01">
            ...
            <div class="bg-[linear-gradient(to_bottom_left,#f3f4f6_60%,#eeeeee_50%)] p-10 rounded shadow-md hover:shadow-lg transition duration-300 ease-in-out shadow-gray-300
                                    outline-gray-400 outline-dashed outline-1 outline-offset-[-20px]">
                <a href="">
                    <img src="{{asset('assets/images/product-category/02.webp')}}" class="mx-auto  transition-transform duration-500 hover:scale-101" alt="01">
            ...
            <div class="bg-[linear-gradient(to_bottom_left,#f3f4f6_60%,#eeeeee_50%)] p-10 rounded shadow-md hover:shadow-lg transition duration-300 ease-in-out shadow-gray-300
                                    outline-gray-400 outline-dashed outline-1 outline-offset-[-20px]">
                <a href="">
                    <img src="{{asset('assets/images/product-category/03.webp')}}" class="mx-auto  transition-transform duration-500 hover:scale-101" alt="01">
            ...
            <div class="bg-[linear-gradient(to_bottom_left,#f3f4f6_60%,#eeeeee_50%)] p-10 rounded shadow-md hover:shadow-lg transition duration-300 ease-in-out shadow-gray-300
                                    outline-gray-400 outline-dashed outline-1 outline-offset-[-20px]">
                <a href="">
                    <img src="{{asset('assets/images/product-category/04.webp')}}" class="mx-auto  transition-transform duration-500 hover:scale-101" alt="01">
            ...
            <div class="bg-[linear-gradient(to_bottom_left,#f3f4f6_60%,#eeeeee_50%)] p-10 rounded shadow-md hover:shadow-lg transition duration-300 ease-in-out shadow-gray-300
                                    outline-gray-400 outline-dashed outline-1 outline-offset-[-20px]">
                <a href="">
                    <img src="{{asset('assets/images/product-category/05.webp')}}" class="mx-auto  transition-transform duration-500 hover:scale-101" alt="01">
            ...
            <div class="bg-[linear-gradient(to_bottom_left,#f3f4f6_60%,#eeeeee_50%)] p-10 rounded shadow-md hover:shadow-lg transition duration-300 ease-in-out shadow-gray-300
                                    outline-gray-400 outline-dashed outline-1 outline-offset-[-20px]">
                <a href="">
                    <img src="{{asset('assets/images/product-category/06.webp')}}" class="mx-auto  transition-transform duration-500 hover:scale-101" alt="01">
            ...
            <div class="bg-[linear-gradient(to_bottom_left,#f3f4f6_60%,#eeeeee_50%)] p-10 rounded shadow-md hover:shadow-lg transition duration-300 ease-in-out shadow-gray-300
                                    outline-gray-400 outline-dashed outline-1 outline-offset-[-20px]">
                <a href="">
                    <img src="{{asset('assets/images/product-category/07.webp')}}" class="mx-auto  transition-transform duration-500 hover:scale-101" alt="01">
            ...
            <div class="bg-[linear-gradient(to_bottom_left,#f3f4f6_60%,#eeeeee_50%)] p-10 rounded shadow-md hover:shadow-lg transition duration-300 ease-in-out shadow-gray-300
                                    outline-gray-400 outline-dashed outline-1 outline-offset-[-20px]">
                <a href="">
                    <img src="{{asset('assets/images/product-category/08.webp')}}" class="mx-auto  transition-transform duration-500 hover:scale-101" alt="01">
            ...
            <div class="bg-[linear-gradient(to_bottom_left,#f3f4f6_60%,#eeeeee_50%)] p-10 rounded shadow-md hover:shadow-lg transition duration-300 ease-in-out shadow-gray-300
                                    outline-gray-400 outline-dashed outline-1 outline-offset-[-20px]">
                <a href="">
                    <img src="{{asset('assets/images/product-category/09.webp')}}" class="mx-auto  transition-transform duration-500 hover:scale-101" alt="01">
            ...
            <div class="bg-[linear-gradient(to_bottom_left,#f3f4f6_60%,#eeeeee_50%)] p-10 rounded shadow-md hover:shadow-lg transition duration-300 ease-in-out shadow-gray-300
                                    outline-gray-400 outline-dashed outline-1 outline-offset-[-20px]">
                <a href="">
                    <img src="{{asset('assets/images/product-category/10.webp')}}" class="mx-auto  transition-transform duration-500 hover:scale-101" alt="01">
            ...
            <div class="bg-[linear-gradient(to_bottom_left,#f3f4f6_60%,#eeeeee_50%)] p-10 rounded shadow-md hover:shadow-lg transition duration-300 ease-in-out shadow-gray-300
                                    outline-gray-400 outline-dashed outline-1 outline-offset-[-20px]">
                <a href="">
                    <img src="{{asset('assets/images/product-category/11.webp')}}" class="mx-auto  transition-transform duration-500 hover:scale-101" alt="01">
            ...
            <div class="bg-[linear-gradient(to_bottom_left,#f3f4f6_60%,#eeeeee_50%)] p-10 rounded shadow-md hover:shadow-lg transition duration-300 ease-in-out shadow-gray-300
                                    outline-gray-400 outline-dashed outline-1 outline-offset-[-20px]">
                <a href="">
                    <img src="{{asset('assets/images/product-category/12.webp')}}" class="mx-auto  transition-transform duration-500 hover:scale-101" alt="01">
