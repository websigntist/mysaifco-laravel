            ...
            <div class="mt-10">
                <ul class="flex flex-wrap text-md font-medium text-center justify-center" id="default-styled-tab"
                    ...
                    <li class="me-2" role="presentation">
                        <button class="inline-block py-2 px-4 rounded-full border-1 border-transparent
                            font-heading italic bg-mst
                            transition duration-300 hover:text-white text-white" id="profile-styled-tab"
                                data-tabs-target="#styled-profile" type="button" role="tab" aria-controls="profile" aria-selected="false">
                            Umrah by Bus
                        </button>
                    </li>
                    <li class="me-2" role="presentation">
                        <button class="inline-block py-2 px-4 rounded-full border-1 border-mst-gray hover:text-white
                                        font-heading italic hover:bg-mst transition duration-300
                ...
                {{--==============--}}
                <div id="default-styled-tab-content" class="mt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 items-center">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex shrink-0 md:pt-1 mt-8">
                                    ...
                                    hover:from-mst-dark
                                     hover:to-mst md:text-lg"> Get more Details
                                        <img
