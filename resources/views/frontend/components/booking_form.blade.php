            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex flex-col text-left">
                        ...
                        <span class="mt-1 font-bold  text-xs md:text-ms">AED <strong class="adult-price-value text-mst font-bold">{{ isset($tour) ? number_format($tour->price, 0) : '150' }}</strong> per head</span>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex flex-col text-left">
                        ...
                        <span class="mt-1 font-bold  text-xs md:text-ms">AED <strong class="child-price-value text-mst font-bold">{{ isset($tour) ? number_format($tour->price, 0) : '150' }}</strong> per head</span>
                    </div>
                    <!-- Dropdown select wrapper -->
                    <div class="relative w-25 md:w-64">
