    ...
    <div class="container mx-auto text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mt-10">
            ...
            hover:shadow-gray-300">
                <a href="">
                    <img src="{{asset('assets/images/blogs/b1.webp')}}" class="mx-auto  transition-transform duration-500
            ...
            <div class="shadow-lg shadow-gray-300 rounded-lg pb-10 overflow-hidden hover:shadow-xl
                        hover:shadow-gray-300">
                <a href=""> <img src="{{asset('assets/images/blogs/b2.webp')}}" class="mx-auto  transition-transform
                duration-500
                                    hover:scale-103" alt="01">
                    <div class="p-5">
            ...
            <div class="shadow-lg shadow-gray-300 rounded-lg pb-10 overflow-hidden hover:shadow-xl
                        hover:shadow-gray-300">
                <a href=""> <img src="{{asset('assets/images/blogs/b3.webp')}}" class="mx-auto  transition-transform
                duration-500
                                    hover:scale-103" alt="01">
                    <div class="p-5">
