...
<?php $__env->startSection('content'); ?>
    ...
    <section class="flex justify-center items-center border-b-1 border-gray-200">
        <div class="px-4 relative flex min-h-[400px] w-full
            ...
            <div class="absolute inset-0 scale-105 bg-cover bg-center bg-no-repeat"
                 style="background-image: url('<?php echo e($bannerImageUrl); ?>')"
                ...
                <div class="testimonials-section-inner mx-auto max-w-6xl">
                    <div class="mx-auto text-center">
                        ...
                        <?php elseif($tourType && ! $page): ?>
                            <h1>
                                <span class="text-mst"><?php echo e($tourType->title); ?></span>
                            </h1>
                        <?php endif; ?>
                        <div class="mt-4">
    ...
    <?php elseif($tourType && filled($tourType->short_description)): ?>
        <section class="flex justify-center items-center py-8 px-4 md:py-10">
            <div class="container mx-auto max-w-6xl text-center">
                <p class="mt-4 text-mst-gray"><?php echo e($tourType->short_description); ?></p>
            </div>
        </section>
    <?php endif; ?>

    <?php echo $__env->make('frontend.pages.includes.all-tours-packages', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
<?php else: ?>
    <?php echo $__env->make('frontend.pages.includes.all-tours-packages', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?>

<?php echo $__env->make('frontend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\frontend\pages\all-tours-packages.blade.php ENDPATH**/ ?>