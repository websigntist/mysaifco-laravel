        ...
        <div class="flex items-center justify-between gap-3 overflow-visible">
            <div class="brand_logo">
                <a href="<?php echo e(url('/')); ?>">
                    <img src="<?php echo e(asset('assets/images/logo.webp')); ?>" class="w-36 md:w-52" alt="brand_logo" title="standard patches">
                </a>
            </div>
...
<?php /**PATH D:\laragon\www\laravel-cursor\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>