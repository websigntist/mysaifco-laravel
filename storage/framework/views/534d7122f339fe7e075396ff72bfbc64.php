                                    ...
                                    <div class="row g-6 pt-5">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label text-capitalize" for="phone">
                                                <span><?php echo e(_label('phone')); ?></span> </label>
                                            <input type="text"
                                                     id="phone"
                                                     name="phone"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text"
                                                          id="subject"
                                                          name="subject"
                                                          value="<?php echo e(old('subject', $data->subject)); ?>"
                                                          class="form-control"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control"
                                                      id="message"
                                                      name="message"
                                                      placeholder="Write <?php echo e(_label('description')); ?>" rows="5"><?php echo e(old ('message', $data->message)); ?></textarea>
                                        </div>
                                        <div class="col-md-4">
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\inquiries\edit.blade.php ENDPATH**/ ?>