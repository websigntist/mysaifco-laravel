        ...
        <div class="col-md-12">
            <label class="form-label text-capitalize" for="smtp_host">
                <?php echo _label('smtp_host'); ?>
                            ...
                            value="<?php echo e(get_setting('smtp_host')); ?>"
                            class="form-control"
        ...
        <div class="col-md-12">
            <label class="form-label text-capitalize" for="smtp_user">
                <?php echo _label('smtp_user'); ?>
                            ...
                            value="<?php echo e(get_setting('smtp_user')); ?>"
                            class="form-control"
        ...
        <div class="col-md-12">
            <label class="form-label text-capitalize" for="smtp_password">
                <?php echo _label('smtp_password'); ?>
                            ...
                            value="<?php echo e(get_setting('smtp_password')); ?>"
                            class="form-control"
        ...
        <div class="col-md-12">
            <label class="form-label text-capitalize" for="smtp_port">
                <?php echo _label('smtp_port'); ?>
                            ...
                            value="<?php echo e(get_setting('smtp_port')); ?>"
                            class="form-control"
        ...
        <div class="col-md-12">
            <label class="form-label text-capitalize" for="recaptcha_site_key">
                <?php echo _label('google_recaptcha_site_key'); ?>
                            ...
                            value="<?php echo e(get_setting('recaptcha_site_key')); ?>"
                            class="form-control"
        ...
        <div class="col-md-12">
            <label class="form-label text-capitalize" for="recaptcha_secret_key">
                <?php echo _label('google_recaptcha_secret_key'); ?>
                            ...
                            value="<?php echo e(get_setting('recaptcha_secret_key')); ?>"
                            class="form-control"
                            placeholder="Enter <?php echo _label('recaptcha_secret_key'); ?>...">
        </div>
    </div>
</div>
<?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/backend/components/smtp_settings.blade.php ENDPATH**/ ?>