                                    ...
                                    <?php $__currentLoopData = $getData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr id="rowId-<?php echo e($data->id); ?>">
                                            ...
                                            <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php endif; ?>
                                                <td class="capitalize">
                                                    <?php if($col === 'quotation_number'): ?>
                                                        <strong class="text-primary"><?php echo e($data->quotation_number); ?></strong>
                                                    ...
                                                    <?php elseif($col === 'quotation_date' || $col === 'valid_until'): ?>
                                                    ...
                                                    <?php elseif($col === 'status'): ?>
                                                        <select class="form-select select2 form-select-sm status-select"
                                                            ...
                                                            <option value="accepted" <?php echo e($data->status == 'accepted' ? 'selected' : ''); ?>>Accepted</option>
                                                            <option value="rejected" <?php echo e($data->status == 'rejected' ? 'selected' : ''); ?>>Rejected</option>
                                                            <option value="expired" <?php echo e($data->status == 'expired' ? 'selected' : ''); ?>>Expired</option>
                                                        </select>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\customer-quotations\listing.blade.php ENDPATH**/ ?>