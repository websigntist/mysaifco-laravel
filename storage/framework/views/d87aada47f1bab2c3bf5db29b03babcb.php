        ...
        <div class="col-md-3">
            <div class="form-check form-switch mt-8">
                ...
                <input type="checkbox" name="settings[facebook_status]" id="facebook_status" class="form-check-input" value="1"
                       <?php if((string) get_setting('facebook_status', '0') === '1'): echo 'checked'; endif; ?>>
            </div>
        </div>
        <!-- instagram -->
        <div class="col-md-9">
        ...
        <div class="col-md-3">
            <div class="form-check form-switch mt-8">
                ...
                <input type="checkbox" name="settings[instagram_status]" id="instagram_status" class="form-check-input" value="1"
                       <?php if((string) get_setting('instagram_status', '0') === '1'): echo 'checked'; endif; ?>>
            </div>
        </div>
        <!-- linkeding -->
        <div class="col-md-9">
        ...
        <div class="col-md-3">
            <div class="form-check form-switch mt-8">
                ...
                <input type="checkbox" name="settings[linkedin_status]" id="linkedin_status" class="form-check-input" value="1"
                       <?php if((string) get_setting('linkedin_status', '0') === '1'): echo 'checked'; endif; ?>>
            </div>
        </div>
        <!-- youtube -->
        <div class="col-md-9">
        ...
        <div class="col-md-3">
            <div class="form-check form-switch mt-8">
                ...
                <input type="checkbox" name="settings[youtube_status]" id="youtube_status" class="form-check-input" value="1"
                       <?php if((string) get_setting('youtube_status', '0') === '1'): echo 'checked'; endif; ?>>
            </div>
        </div>
        <!-- x twitter -->
        <div class="col-md-9">
        ...
        <div class="col-md-3">
            <div class="form-check form-switch mt-8">
                ...
                <input type="checkbox" name="settings[twitter_status]" id="twitter_status" class="form-check-input" value="1"
                       <?php if((string) get_setting('twitter_status', '0') === '1'): echo 'checked'; endif; ?>>
            </div>
        </div>
        <!-- tiktok -->
        <div class="col-md-9">
        ...
        <div class="col-md-3">
            <div class="form-check form-switch mt-8">
                ...
                <input type="checkbox" name="settings[tiktok_status]" id="tiktok_status" class="form-check-input" value="1"
                       <?php if((string) get_setting('tiktok_status', '0') === '1'): echo 'checked'; endif; ?>>
            </div>
        </div>
    </div>
</div>
<?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/backend/components/social_networks.blade.php ENDPATH**/ ?>