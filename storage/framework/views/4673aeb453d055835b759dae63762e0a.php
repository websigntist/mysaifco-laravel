                                ...
                                <div class="row g-6 pt-5">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text" id="friendlyUrl"><?php echo e(route('/')); ?>/</span>
                                            <input type="text"
                                                   class="form-control"
                                                   id="friendly_url"
                                                   name="friendly_url"
                                    ...
                                    <div class="col">
                                        <label class="form-label text-capitalize" for="tour_location">
                                            <?php echo e(_label('tour_location')); ?>

                                        </label> <input type="text"
                                                        id="tour_location"
                                                        name="tour_location"
                                                        value="<?php echo e(old('tour_location', $data->tour_location)); ?>"
                                                        class="form-control"
                                                        placeholder="Enter <?php echo e(_label('tour_location')); ?>...">
                                    </div>
                                    <div class="col">
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/backend/tours/edit.blade.php ENDPATH**/ ?>