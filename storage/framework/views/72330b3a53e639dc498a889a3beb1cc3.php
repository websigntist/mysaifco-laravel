                                                ...
                                                <?php if($col === 'image'): ?>
                                                    <div class="d-flex justify-content-start align-items-center user-name">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            </a> <small><?php echo e(Str::words(strip_tags($data->description), 10, '...')); ?></small>
                                                        </div>
                                                    </div>
                                                <?php elseif($col === 'parent_id'): ?>
                                                    <?php if($data->parentCategory?->title): ?>
                                                        <span class="badge badge-outline-warning"><?php echo e($data->parentCategory?->title); ?></span>
                                                    <?php else: ?>
                ...
                `;
                    ...
                    try {
                        ...
                        const rows = `
                            ...
                            <tr><th><?php echo e(_label('parent_category')); ?></th><td>${data.parent_page_title ?? '/Parent'}</td></tr>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\product-category\listing.blade.php ENDPATH**/ ?>