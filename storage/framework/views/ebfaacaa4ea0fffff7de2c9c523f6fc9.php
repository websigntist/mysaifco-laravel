                                        ...
                                        <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <td class="capitalize">
                                                ...
                                                <?php elseif($col === 'categories'): ?>
                                                    <?php $__empty_1 = true; $__currentLoopData = $data->blogCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                        <span class="badge badge-outline-warning mb-1">
                                                        <?php echo e($category->title); ?>

                                                        </span>
                                                        <br>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                        <span class="badge badge-outline-gray">Not Selected</span>
                                                    <?php endif; ?>
                                                <?php elseif($col === 'tags'): ?>
                                                    <?php $__empty_1 = true; $__currentLoopData = $data->blogTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                        <span class="badge badge-outline-primary mb-1">
                                                            <?php echo e($tag->title); ?>

                                                        </span><br>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                        <span class="badge badge-outline-gray">No Tag</span>
                                                    <?php endif; ?>
            ...
            document.querySelectorAll(".viewBtn").forEach(btn => {
                ...
                `;
                    ...
                    try {
                        ...
                        // 🟢 Generate dynamic badges for categories and tags
                        const categories = data.categories?.length
                            ? data.categories.map(cat =>
                                `<span class="badge bg-label-primary me-1 mb-1">${cat}</span>`
                            ).join('')
                            : '<span class="badge bg-label-secondary">Not Selected</span>';

                        const tags = data.tags?.length
                            ? data.tags.map(tag =>
                                `<span class="badge bg-label-danger me-1 mb-1">${tag}</span>`
                            ).join('')
                            : '<span class="badge bg-label-secondary">No Tag</span>';

                        // Build data rows
                        const rows = `
                            <tr><th>ID</th><td>${data.id ?? '-'}</td></tr>
                            <tr><th><?php echo e(_label('categories')); ?></th><td>${categories}</td></tr>
                            <tr><th><?php echo e(_label('tags')); ?></th><td> ${tags} </td></tr>
                            <tr><th><?php echo e(_label('title')); ?></th><td>${data.title ?? '-'}</td></tr>
                            <tr><th><?php echo e(_label('friendly_url')); ?></th><td>${data.friendly_url ?? '-'}</td></tr>
                            <tr>
                                <th><?php echo e(_label('description')); ?></th>
                                <td>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\blogs\listing.blade.php ENDPATH**/ ?>