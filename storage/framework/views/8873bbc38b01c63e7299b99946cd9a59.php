<?php $__env->startSection('content'); ?>
    <div class="container-xxl flex-grow-1 mt-3 -container-p-y">
        <form action="<?php echo e(route('product-category.import')); ?>" method="post" id="importForm" class="needs-validation"
                ...
                <div class="col-sm-12 col-xl-8 offset-lg-2">
                    <div class="d-flex justify-content-between align-items-center mb-3 mt-5">
                        ...
                        <div class="card-header-elements ms-auto d-flex align-content-between">
                            <?php echo goBack($categories,'Import CSV'); ?>
                    ...
                    <div class="card card-action border-top-bottom">
                        <div class="card-header border-bottom py-3 d-flex justify-content-between align-items-center">
                            <h6 class="mb-0 text-capitalize">
                                <span class="icon-sm icon-base ti tabler-apps iconmrgn me-1"></span> Select and import
                                                                                                     the data
                            </h6>
                                ...
                                <div class="row g-5 pt-5 d-flex justify-content-center ">
                                    ...
                                    <div class="col-sm-12 col-md-4 justify-end d-flex">
                                        <button type="submit" class="actionBtns btn btn-primary waves-effect waves-light">
                                            <span class="icon-base ti tabler-database-plus icon-20px me-2"></span>Import
                                                                                                                  CSV
                                        </button>
                                    </div>
                                </div>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\product-category\import.blade.php ENDPATH**/ ?>