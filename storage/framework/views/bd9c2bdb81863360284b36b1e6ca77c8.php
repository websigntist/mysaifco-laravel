                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm">
                                        ...
                                        <?php $__currentLoopData = $data->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                                                    <img src="<?php echo e($img->image ? asset('assets/images/galleries/images/'.$img->image) : imageNotFound()); ?>" alt="" class="border rounded-circle" style="max-height: 60px;">
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\galleries\edit.blade.php ENDPATH**/ ?>