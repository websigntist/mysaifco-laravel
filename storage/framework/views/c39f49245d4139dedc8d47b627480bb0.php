<ul class="site-navbar__list flex w-full flex-col gap-0.5 p-0 text-sm font-medium md:flex-row md:items-center md:justify-end md:gap-1 lg:gap-2">
    <li class="block rounded-full text-white bg-gradient-to-r from-[#BA9B31] to-[#74611E] transition duration-300">
        <a href="<?php echo e(route('/')); ?>" class="block py-2.5 px-4 md:py-2 md:px-3" aria-current="page">Home</a>
    </li>
    <li class="block text-mst-gray transition duration-300 hover:rounded-full hover:bg-gradient-to-r hover:from-[#BA9B31] hover:to-[#74611E] hover:text-white">
        <a href="<?php echo e(route('page.default','all-tour-categories')); ?>" class="block py-2.5 px-4 md:py-2 md:px-3">UAE Tour</a>
    </li>
    <li class="block text-mst-gray transition duration-300 hover:rounded-full hover:bg-gradient-to-r hover:from-[#BA9B31] hover:to-[#74611E] hover:text-white">
        <a href="<?php echo e(route('page.default', 'desert-safari-tours')); ?>" class="block py-2.5 px-4 md:py-2 md:px-3">Desert Safari</a>
    </li>
    <li class="block text-mst-gray transition duration-300 hover:rounded-full hover:bg-gradient-to-r hover:from-[#BA9B31] hover:to-[#74611E] hover:text-white">
    ...
    <li class="block text-mst-gray transition duration-300 hover:rounded-full hover:bg-gradient-to-r hover:from-[#BA9B31] hover:to-[#74611E] hover:text-white">
        <a href="<?php echo e(route('page.default', 'contact-us')); ?>" class="block py-2.5 px-4 md:py-2 md:px-3">Contact</a>
    </li>
</ul>
<?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/frontend/components/navbar-menu.blade.php ENDPATH**/ ?>