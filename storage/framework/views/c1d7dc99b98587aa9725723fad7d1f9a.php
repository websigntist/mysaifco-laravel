                        ...
                        <div class="card card-action border-top-bottom">
                            <div class="card-header border-bottom py-3 d-flex justify-content-between align-items-center">
                                <h6 class="mb-0 text-capitalize">
                                    ...
                                    Fill Out The <?php echo e(ucfirst(str_replace('-',' ',$title))); ?>Details
                                </h6>
                                    ...
                                    <div class="row g-6 pt-5">
                                        <div class="col-sm-12 col-md-6">
                                            ...
                                            <select id="parent_id" name="parent_id" class="form-select select2" required>
                                                ...
                                                <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module_id => $module_title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e(old($module_id, $module_id)); ?>"><?php echo e(ucfirst($module_title)); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            ...
                                            <input type="text"
                                                   id="module_title"
                                                   name="module_title"
                                                   value="<?php echo e(old('module_title')); ?>"
                                                   class="form-control"
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            ...
                                            <input type="text"
                                                   id="module_slug"
                                                   name="module_slug"
                                                   value="<?php echo e(old('module_slug')); ?>"
                                                   class="form-control"
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            ...
                                            <input type="text"
                                                   id="actions"
                                                   name="actions"
                                                   value="<?php echo e(old('actions', 'nil')); ?>"
                                                   class="form-control"
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\modules\form.blade.php ENDPATH**/ ?>