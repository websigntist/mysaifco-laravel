                ...
                <div class="col-sm-12 col-md-10 offset-md-1 mt-3">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div class="d-flex flex-column justify-content-center">
                            <?php echo heading_breadcrumbs('Customer Invoice Details'); ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-5" style="margin-top: 250px;">
                                <div class="col-md-12 mb-10">
                                    ...
                                    ?>
                                    <h3 class="text-center fw-semibold"><?php echo e($invoiceTypeTitle); ?></h3>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6 d-flex justify-content-end">
                                    <div>
                                        ...
                                        <p class="mb-1"><strong>invoice #:</strong> <?php echo e($getData->invoice_number); ?></p>
                                        <p class="mb-1">
                                            <strong>Date:</strong> <?php echo e($getData->invoice_date->format('M d, Y')); ?>

                                        </p>
                                        <p class="mb-1"><strong>Due
                                                                Date:</strong> <?php echo e($getData->due_date->format('M d, Y')); ?>

                                        </p>
                                        <p class="mb-1"><strong>Payment Status:</strong>
                                            <?php echo e(ucwords($getData->payment_status)); ?></p>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\customer-invoices\view.blade.php ENDPATH**/ ?>