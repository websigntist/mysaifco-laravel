<div class="flex justify-center items-center border-b-1 border-gray-200">
    <div
        ...
        <div class="absolute inset-0 scale-105 bg-cover bg-center bg-no-repeat -blur-[3px] bg-gray-50"
             style="background-image: url('<?php echo e(asset('assets/images/home-page-hero.webp')); ?>')"
...
<?php /**PATH D:\laragon\www\laravel-cursor\resources\views/frontend/components/hero_section.blade.php ENDPATH**/ ?>