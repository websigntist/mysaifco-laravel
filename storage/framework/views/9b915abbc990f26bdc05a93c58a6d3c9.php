<?php $__env->startSection('content'); ?>
    <div class="container-xxl flex-grow-1 mt-3 -container-p-y">
        <form action="<?php echo e(route('blogs.import')); ?>" method="post" id="importForm" class="needs-validation"
                                ...
                                <div class="row g-5 pt-5 d-flex justify-content-center ">
                                    ...
                                    <div class="col-sm-12 col-md-4 justify-end d-flex">
                                        <button type="submit" class="actionBtns btn btn-primary waves-effect waves-light">
                                            <span class="icon-base ti tabler-database-plus icon-20px me-2"></span>Upload
                                                                                                                  CSV
                                        </button>
                                    </div>
                                </div>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\blogs\import.blade.php ENDPATH**/ ?>