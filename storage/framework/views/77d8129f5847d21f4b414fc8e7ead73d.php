                                ...
                                <div class="row g-6 pt-5">
                                    <div class="col-md-12">
                                        <label class="form-label text-capitalize" for="title">
                                            <span><?php echo e(_label('template_title')); ?></span> </label>
                                        <input type="text"
                                               id="title"
                                               name="title"
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label text-capitalize" for="slug">
                                            <span><?php echo e(_label('template_slug')); ?></span> </label>
                                        <input type="text"
                                               id="slug"
                                               name="slug"
                                               value="<?php echo e(old('slug', $data->slug)); ?>"
                                               class="form-control"
                                               placeholder="Enter <?php echo e(_label('slug')); ?>...">
                                    </div>
                                    <div class="col-md-12">
                                        <textarea name="description" class="form-control" id="editor" required><?php echo e(old('',$data->description)); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row g-6 pt-5">
                                    <div class="col-md-12">
                                        ...
                                        <?php if(!empty($data->document)): ?>
                                            ...
                                            <a href="<?php echo e(asset('assets/documents/'. $data->document)); ?>" download>
                                        ...
                                        <?php else: ?>
                                            <div class="text-center">
                                                <img src="<?php echo e(asset('assets/backend/images/noimg.jpg')); ?>"
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\email-templates\edit.blade.php ENDPATH**/ ?>