                    ...
                    <div class="card card-action border-top-bottom">
                        ...
                        <div class="collapse show">
                            <div class="card-body">
                                <div class="row g-6 pt-5">
                                    <div class="col-md-12">
                                        <?php echo image_input_option($data->icon ? asset('assets/images/'.$module.'/'.$data->icon) : imageNotFound(), 'icon'); ?>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\red-tags\edit.blade.php ENDPATH**/ ?>