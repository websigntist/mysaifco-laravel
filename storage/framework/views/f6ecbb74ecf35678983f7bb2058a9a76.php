                            ...
                            <div class="card-body">
                                <div class="row g-6 pt-5">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <small class="text-muted">Frontend URL: <?php echo e(url('/')); ?>/<span id="friendly_url_preview"><?php echo e(old('friendly_url', 'your-slug')); ?></span></small>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control"
                                                  ...
                                                  rows="4"><?php echo e(old('short_description')); ?></textarea>
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label text-capitalize" for="description">Tour Description</label>
                                ...
                                <div class="row g-6 pt-5">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text"
                                               ...
                                               class="form-control"
                                               placeholder="Enter <?php echo e(_label('meta_title')); ?>...">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control"
                                                  ...
                                                  placeholder="Write <?php echo e(_label('meta_description')); ?>"
                                ...
                                <div class="row g-6 pt-5">
                                    <div class="col-md-12">
                                        ...
                                        <select id="status" name="status" class="form-select select2" required>
                                            <?php $__currentLoopData = $getStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($status); ?>" <?php echo e(old('status', 'Active') === $status ? 'selected' : ''); ?>>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text"
                                               id="view_all_link"
                                               name="view_all_link"
                                               value="<?php echo e(old('view_all_link')); ?>"
                                               class="form-control"
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/backend/tour-types/form.blade.php ENDPATH**/ ?>