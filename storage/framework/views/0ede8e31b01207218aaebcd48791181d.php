<form class="quote-form max-w-lg mx-auto -bg-std-opt
bg-[linear-gradient(to_bottom_left,#03354DCC_70%,#05293ACC_50%)]
 hover:bg-[linear-gradient(to_bottom_left,#05293ACC_70%,#03354DCC_50%)] transition-all duration-100 ease-in-out
 p-16 rounded-2xl outline-white outline-dashed outline-1
outline-offset-[-25px] [color-scheme:dark]">
    <h2 class="text-white text-center text-2xl font-bold uppercase mb-4 border-b-1 border-b-white">Get free quote</h2>
...
<?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/frontend/components/quote_form.blade.php ENDPATH**/ ?>