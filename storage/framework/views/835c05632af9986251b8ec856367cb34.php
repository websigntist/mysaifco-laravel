<?php if(!empty($sliders) && isset($sliders[0]) && $sliders[0]->status == 'Active'): ?>
    ...
    overflow-hidden">
            <div class="absolute inset-0 scale-105 bg-cover bg-center bg-no-repeat"
                 style="background-image: url('<?php echo e(asset('assets/images/sliders/'.$sliders[0]->image)); ?>')"
                ...
                <div class="container mx-auto w-full">
                    <div class="grid w-full grid-cols-1 md:grid-cols-2 items-center gap-5">
                        ...
                        italic leading-12 md:leading-14 tracking-wide w-10/12">
                                <?php echo e($sliders[0]->heading); ?>

                            </h1>
                            <p class="text-lg text-white text-center md:text-left mt-6 leading-7 w-10/12">
                                <?php echo e($sliders[0]->description); ?>

                            </p>
                            
                            <div class="mt-8 mb-4">
                                <a href="<?php echo e($sliders[0]->link ?? '#'); ?>" class="flex items-center justify-center w-44
                            ...
                            bg-gradient-to-r from-[#BA9B31] to-[#74611E]
                             ...
                             transition duration-300 font-heading italic"> <?php echo e($sliders[0]->button_text); ?>
