                                    ...
                                    <tr id="rowId-<?php echo e($data->id); ?>">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <?php echo actionButton2($module, 'edit', route($module.'.edit', $data->id),
                                                 'Edit', $data->id, 'Edit', 'tabler-edit', 'btn btn-text-secondary
                                                 rounded-pill waves-effect btn-icon'); ?>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/backend/testimonials/listing.blade.php ENDPATH**/ ?>