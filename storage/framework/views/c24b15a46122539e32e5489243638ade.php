<section class="">
    <div class="px-4 relative flex w-full items-start justify-center overflow-hidden">
        <div class="absolute inset-0 scale-100 bg-cover bg-top bg-no-repeat" style="background-image: url('<?php echo e(asset('assets/images/pages/1784011979_6a55dccb9d9fb_image.webp')); ?>')" aria-hidden="true"></div>
        ...
        <div class="relative z-10 w-full py-14">
            <div class="container mx-auto">
                <nav class="breadcrumb flex items-center gap-1 text-md font-heading" aria-label="Breadcrumb">
                    <a href="<?php echo e(url('/')); ?>" class="text-white hover:text-mst transition">Home</a>
                    <svg class="w-4 h-4 text-mst" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m9 5 7 7-7 7"/>
                    </svg>
                    <span class="text-mst">Holiday Packages</span>
                </nav>
                <h1 class="text-5xl w-4xl mt-6 font-body font-bold not-italic leading-16 text-white">
                    Holiday Packages
                </h1>
                <p class="text-lg mt-5 w-6/12 text-white">Discover carefully curated holiday packages from Dubai and Pakistan to the world’s exciting destinations</p>
...
<section class="pt-12">
    <div class="container mx-auto">
        <form action="#" method="GET" class="bg-gray-50 border border-gray-200 rounded-3xl p-6 md:p-8">
            <h2 class="font-heading italic font-bold text-2xl md:text-xl text-mst-gray mb-6">Find your Perfect Holiday</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
                <div>
                    <label class="block font-body font-semibold text-sm text-mst-gray mb-2">Destination</label>
                    <select name="destination" class="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-sm text-mst-gray focus:outline-none focus:border-mst">
                ...
                <div>
                    <label class="block font-body font-semibold text-sm text-mst-gray mb-2">Travel Month</label>
                    <select name="month" class="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-sm text-mst-gray focus:outline-none focus:border-mst">
                ...
                <div>
                    <label class="block font-body font-semibold text-sm text-mst-gray mb-2">Duration</label>
                    <select name="duration" class="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-sm text-mst-gray focus:outline-none focus:border-mst">
                ...
                <div>
                    <label class="block font-body font-semibold text-sm text-mst-gray mb-2">Budget</label>
                    <select name="budget" class="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-sm text-mst-gray focus:outline-none focus:border-mst">
                        <option value="">Any budget</option>
                        <option>Under AED 500</option>
                        <option>AED 500 - 1,000</option>
                        <option>AED 1,000 - 2,500</option>
                        <option>AED 2,500+</option>
                    </select>
                </div>
                <button type="submit" class="w-full inline-flex items-center justify-center gap-2 rounded-lg px-6 py-3
                        font-heading italic text-white text-md
                        bg-mst">
                    Search Packages
                </button>
            </div>
...
<section class="pt-14">
    <div class="container mx-auto">
        <div class="mb-8">
            <h2 class="font-heading italic font-bold text-2xl md:text-3xl text-mst-gray">Popular Holiday <span class="text-mst">Packages</span></h2>
            <p class="font-body text-mst-gray mt-2">Handpicked packages with the best experiences and unbeatable value.</p>
        </div>
        <?php
            $packages = [
                ['name' => 'Dubai',      'image' => 'holiday-package-6.webp', 'duration' => '5 Days / 4 Nights', 'price' => '169'],
                ['name' => 'Turkey',     'image' => 'holiday-package-1.webp', 'duration' => '5 Days / 4 Nights', 'price' => '169'],
                ['name' => 'Azerbaijan', 'image' => 'holiday-package-2.webp', 'duration' => '5 Days / 4 Nights', 'price' => '169'],
                ['name' => 'Georgia',    'image' => 'holiday-package-3.webp', 'duration' => '5 Days / 4 Nights', 'price' => '169'],
                ['name' => 'Thailand',   'image' => 'holiday-package-4.webp', 'duration' => '5 Days / 4 Nights', 'price' => '169'],
                ['name' => 'Maldives',   'image' => 'holiday-package-5.webp', 'duration' => '5 Days / 4 Nights', 'price' => '169'],
            ];
        ?>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="bg-white border border-gray-200 rounded-2xl overflow-hidden flex flex-col">
                    <img src="<?php echo e(asset('assets/images/packages/' . $package['image'])); ?>"
                         alt="<?php echo e($package['name']); ?>"
                         class="w-full h-52 object-cover"
                         loading="lazy">
                    <div class="p-5 flex flex-col flex-1">
                        <h3 class="font-heading font-bold text-2xl text-mst-gray"><?php echo e($package['name']); ?></h3>
                        <p class="font-body text-sm text-gray-600 mt-2"><?php echo e($package['duration']); ?></p>
                        <div class="flex items-end justify-between mt-4">
                            <div>
                                <p class="font-body text-sm text-gray-600">Starting</p>
                                <p class="font-heading font-bold text-lg text-mst-gray">AED <?php echo e($package['price']); ?><span class="font-body font-normal text-sm text-gray-600">/person</span></p>
                            </div>
                            <a href="#" class="inline-flex items-center justify-center gap-2 rounded-full px-5 py-2 flex-shrink-0
                                ...
                                View Package
                                <img src="<?php echo e(asset('assets/images/icons/btn-arrow.svg')); ?>" class="w-4" alt="">
                            </a>
                        </div>
                    </div>
                </article>
...
<section class="pt-14">
    <div class="container mx-auto">
        <h2 class="font-heading italic font-bold text-xl text-mst-gray mb-6">Explore by <span class="text-mst">Travel Category</span></h2>
        <?php
            $categories = [
                ['label' => 'Beach Holidays',  'emoji' => '989.svg'],
                ['label' => 'City Breaks',     'emoji' => '90.svg'],
                ['label' => 'Religious Tours', 'emoji' => '0598.svg'],
                ['label' => 'Family Holidays', 'emoji' => '130.svg'],
                ['label' => 'Honeymoon Tours', 'emoji' => '0445.svg'],
                ['label' => 'Adventure Tours', 'emoji' => '966.svg'],
            ];
        ?>
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="#" class="group flex flex-col items-center justify-center text-center gap-3 bg-gray-50 border border-gray-200 rounded-2xl py-8 px-4 transition duration-300 hover:border-mst hover:shadow-sm">
                    <img src="<?php echo e(asset('assets/images/icons/' . $category['emoji'])); ?>" alt="">
                    <span class="font-heading italic font-bold text-mst-gray group-hover:text-mst transition"><?php echo e($category['label']); ?></span>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<section class="pt-14">
    <div class="container mx-auto">
        <div class="mb-6">
            <h2 class="font-heading italic font-bold text-xl text-mst-gray">Why Book <span class="text-mst">with Saifco?</span></h2>
            <p class="font-body text-mst-gray mt-2 text-sm">We make your travel smooth, comfortable, and memorable.</p>
        </div>
        <?php
            $reasons = [
                ['title' => 'Since 2008',      'sub' => 'Trusted Travel Partner', 'icon'  => '9898.svg'],
                ['title' => '50,000+',         'sub' => 'Happy Travelers', 'icon'  => '17years.svg'],
                ['title' => 'Best Price',      'sub' => 'Competitive Prices', 'icon'  => 'dbadge.svg'],
                ['title' => 'Custom Packages', 'sub' => 'Tailored To Your Needs', 'icon'  => '5326.svg'],
                ['title' => 'Visa Assistance', 'sub' => 'End-to-End Support', 'icon'  => 'v565.svg'],
                ['title' => "24/7 Customer",   'sub' => "We're Here to Help", 'icon'  => 'support2.svg'],
            ];
        ?>
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <?php $__currentLoopData = $reasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex flex-col items-center justify-center text-center gap-2 bg-gray-50 border border-gray-200 rounded-2xl py-8 px-4">
                    <img src="<?php echo e(asset('assets/images/icons/' . $reason['icon'])); ?>" alt="">
                    <span class="font-heading italic font-bold text-mst-gray mt-1"><?php echo e($reason['title']); ?></span>
                    <span class="font-body text-xs text-gray-600 leading-tight"><?php echo e($reason['sub']); ?></span>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/frontend/pages/includes/holiday-packages.blade.php ENDPATH**/ ?>