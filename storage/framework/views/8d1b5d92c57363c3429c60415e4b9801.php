                                    ...
                                    <div class="row g-6 pt-5">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                   id="heading"
                                                   name="heading"
                                                   value="<?php echo e(old('heading', $data->heading)); ?>"
                                                   class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                  id="sub_heading"
                                                  name="sub_heading"
                                                  value="<?php echo e(old('sub_heading', $data->sub_heading)); ?>"
                                                  class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                   id="link"
                                                   name="link"
                                                   value="<?php echo e(old('link', $data->link)); ?>"
                                                   class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                  id="button_text"
                                                  name="button_text"
                                                  value="<?php echo e(old('button_text', $data->button_text)); ?>"
                                                  class="form-control"
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/backend/sliders/edit.blade.php ENDPATH**/ ?>