<section class="flex justify-center items-center border-b-1 border-gray-200">
    <div class="px-4 relative flex min-h-[400px] w-full
        ...
        <div class="absolute inset-0 scale-100 bg-cover bg-top bg-no-repeat"
             style="background-image: url('<?php echo e(asset('assets/images/pages/1782556549_6a3fa7851bfc7_image.webp')); ?>')"
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-0 md:divide-x md:divide-gray-200">
                    ...
                    <div class="flex flex-col items-center text-center px-2 py-4">
                        <div class="w-12 h-12 flex items-center justify-center mb-3">
                            <img src="<?php echo e(asset('assets/images/icons/17years.svg')); ?>" alt="17+ Years Experience" class="w-full h-full object-contain">
                        </div>
                    ...
                    <div class="flex flex-col items-center text-center px-2 py-4">
                        <div class="w-12 h-12 flex items-center justify-center mb-3">
                            <img src="<?php echo e(asset('assets/images/icons/17years.svg')); ?>" alt="50,000+ Travelers Served" class="w-full h-full object-contain">
                        </div>
                        <h3 class="font-heading italic font-bold text-mst-gray text-sm md:text-[15px] leading-tight">
                    ...
                    <div class="flex flex-col items-center text-center px-2 py-4">
                        <div class="w-12 h-12 flex items-center justify-center mb-3">
                            <img src="<?php echo e(asset('assets/images/icons/support2.svg')); ?>" alt="24/7 Customer Support" class="w-full h-full object-contain">
                        </div>
                        <h3 class="font-heading italic font-bold text-mst-gray text-sm md:text-[15px] leading-tight">
                    ...
                    <div class="flex flex-col items-center text-center px-2 py-4">
                        <div class="w-12 h-12 flex items-center justify-center mb-3">
                            <img src="<?php echo e(asset('assets/images/icons/dbadge.svg')); ?>" alt="Best Price Guaranteed" class="w-full h-full object-contain">
                        </div>
                        <h3 class="font-heading italic font-bold text-mst-gray text-sm md:text-[15px] leading-tight">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-5">
            ...
            <a href="#" class="group flex flex-col items-center text-center p-5 bg-white border border-gray-200 rounded-2xl transition-all duration-300 hover:shadow-md hover:border-mst shadow-[0_8px_30px_rgb(0,0,0,0.015)] cursor-pointer">
                <div class="w-16 h-16 flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110">
                    <img src="<?php echo e(asset('assets/images/icons/dubai.svg')); ?>" alt="UAE Travel" class="w-full h-full object-contain">
                </div>
            ...
            <a href="#" class="group flex flex-col items-center text-center p-5 bg-white border border-gray-200 rounded-2xl transition-all duration-300 hover:shadow-md hover:border-mst shadow-[0_8px_30px_rgb(0,0,0,0.015)] cursor-pointer">
                <div class="w-16 h-16 flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110">
                    <img src="<?php echo e(asset('assets/images/icons/kaba.svg')); ?>" alt="Umrah Guide" class="w-full h-full object-contain">
                </div>
                <h4 class="font-heading italic font-bold text-[18px] leading-tight">
            ...
            <a href="#" class="group flex flex-col items-center text-center p-5 bg-white border border-gray-200 rounded-2xl transition-all duration-300 hover:shadow-md hover:border-mst shadow-[0_8px_30px_rgb(0,0,0,0.015)] cursor-pointer">
                <div class="w-16 h-16 flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110">
                    <img src="<?php echo e(asset('assets/images/icons/desert.svg')); ?>" alt="Desert Safari" class="w-full h-full object-contain">
                </div>
                <h4 class="font-heading italic font-bold text-[18px] leading-tight">
            ...
            <a href="#" class="group flex flex-col items-center text-center p-5 bg-white border border-gray-200 rounded-2xl transition-all duration-300 hover:shadow-md hover:border-mst shadow-[0_8px_30px_rgb(0,0,0,0.015)] cursor-pointer">
                <div class="w-16 h-16 flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110">
                    <img src="<?php echo e(asset('assets/images/icons/yacht.svg')); ?>" alt="Yacht Charter" class="w-full h-full object-contain">
                </div>
                <h4 class="font-heading italic font-bold text-[18px] leading-tight">
            ...
            <a href="#" class="group flex flex-col items-center text-center p-5 bg-white border border-gray-200 rounded-2xl transition-all duration-300 hover:shadow-md hover:border-mst shadow-[0_8px_30px_rgb(0,0,0,0.015)] cursor-pointer">
                <div class="w-16 h-16 flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110">
                    <img src="<?php echo e(asset('assets/images/icons/visa1.svg')); ?>" alt="UAE Visa" class="w-full h-full object-contain">
                </div>
                <h4 class="font-heading italic font-bold text-[18px] leading-tight">
            ...
            <a href="#" class="group flex flex-col items-center text-center p-5 bg-white border border-gray-200 rounded-2xl transition-all duration-300 hover:shadow-md hover:border-mst shadow-[0_8px_30px_rgb(0,0,0,0.015)] cursor-pointer">
                <div class="w-16 h-16 flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110">
                    <img src="<?php echo e(asset('assets/images/icons/dubai.svg')); ?>" alt="Abu Dhabi Tours" class="w-full h-full object-contain">
                </div>
                <h4 class="font-heading italic font-bold text-[18px] leading-tight">
            ...
            <a href="#" class="group flex flex-col items-center text-center p-5 bg-white border border-gray-200 rounded-2xl transition-all duration-300 hover:shadow-md hover:border-mst shadow-[0_8px_30px_rgb(0,0,0,0.015)] cursor-pointer">
                <div class="w-16 h-16 flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110">
                    <img src="<?php echo e(asset('assets/images/icons/holiday.svg')); ?>" alt="Holiday Packages" class="w-full h-full object-contain">
                </div>
                <h4 class="font-heading italic font-bold text-[18px] leading-tight">
            ...
            <a href="#" class="group flex flex-col items-center text-center p-5 bg-white border border-gray-200 rounded-2xl transition-all duration-300 hover:shadow-md hover:border-mst shadow-[0_8px_30px_rgb(0,0,0,0.015)] cursor-pointer">
                <div class="w-16 h-16 flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110">
                    <img src="<?php echo e(asset('assets/images/icons/tips.svg')); ?>" alt="Travel Tips" class="w-full h-full object-contain">
                </div>
                <h4 class="font-heading italic font-bold text-[18px] leading-tight">
            ...
            <div class="blogRight min-w-0">
                <div class="cover-blog bg-gray-50 border border-gray-200 p-5 rounded-2xl flex flex-col md:flex-row gap-6">
                    ...
                    <div class="relative w-full md:w-[45%] h-[260px] md:h-[300px] flex-shrink-0 rounded-2xl overflow-hidden">
                        <img src="<?php echo e(asset('assets/images/91d9ed0181f54a5e5eef312d07045557fc90311b-original.webp')); ?>" alt="Complete Umrah Guide" class="w-full h-full object-cover">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="border border-gray-200 rounded-2xl overflow-hidden flex flex-col h-full">
                            <div class="relative w-full h-[200px] overflow-hidden">
                                <img src="<?php echo e(asset('assets/images/f27fd1a41f4b718bfd6da3cb787ece5195bab2ca-original.webp')); ?>" alt="Desert Safari" class="w-full h-full object-cover transition-transform duration-500 hover:scale-105">
                            </div>
                        ...
                        <div class="border border-gray-200 rounded-2xl overflow-hidden flex flex-col h-full">
                            <div class="relative w-full h-[200px] overflow-hidden">
                                <img src="<?php echo e(asset('assets/images/627727e24441f5e0b9c98e7e7155c6b8e41b28cb-original.webp')); ?>" alt="Desert Safari" class="w-full h-full object-cover transition-transform duration-500 hover:scale-105">
                            </div>
                            <div class="p-3 flex flex-col flex-1">
                                <h3 class="font-heading font-bold text-xl text-mst-gray mb-3 leading-snug
                                                        hover:text-mst transition-colors duration-200 line-clamp-2">
                        ...
                        <div class="border border-gray-200 rounded-2xl overflow-hidden flex flex-col h-full">
                            <div class="relative w-full h-[200px] overflow-hidden">
                                <img src="<?php echo e(asset('assets/images/3754530afa51e91aebdd8958304807da623d7c68-original.webp')); ?>" alt="Desert Safari" class="w-full h-full object-cover transition-transform duration-500 hover:scale-105">
                            </div>
                            <div class="p-3 flex flex-col flex-1">
                                <h3 class="font-heading font-bold text-xl text-mst-gray mb-3 leading-snug
                                                        hover:text-mst transition-colors duration-200 line-clamp-2">
                ...
                <div class="blogsearch bg-gray-50 border border-gray-200 p-6 rounded-2xl">
                    ...
                    <div class="relative">
                        ...
                        <button class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-mst transition-colors">
                            <img src="<?php echo e(asset('assets/images/icons/search-icons.svg')); ?>" alt="UAE Tours" class="w-5 h-5 object-contain">
                        </button>
                    </div>
                </div>
                <!-- Categories -->
                    ...
                    <div class="flex flex-col">
                        ...
                        <a href="#" class="flex items-center justify-between py-3 hover:text-mst transition-colors duration-200">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e(asset('assets/images/icons/dubai.svg')); ?>" alt="UAE Tours" class="w-6 h-6 object-contain">
                        ...
                        <a href="#" class="flex items-center justify-between py-3 hover:text-mst transition-colors duration-200">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e(asset('assets/images/icons/kaba.svg')); ?>" alt="Umrah Guide" class="w-6 h-6 object-contain">
                        ...
                        <a href="#" class="flex items-center justify-between py-3 hover:text-mst transition-colors duration-200">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e(asset('assets/images/icons/desert.svg')); ?>" alt="Desert Safari" class="w-6 h-6 object-contain">
                        ...
                        <a href="#" class="flex items-center justify-between py-3 hover:text-mst transition-colors duration-200">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e(asset('assets/images/icons/yacht.svg')); ?>" alt="Yacht Charter" class="w-6 h-6 object-contain">
                        ...
                        <a href="#" class="flex items-center justify-between py-3 hover:text-mst transition-colors duration-200">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e(asset('assets/images/icons/visa1.svg')); ?>" alt="UAE Visa" class="w-6 h-6 object-contain">
                        ...
                        <a href="#" class="flex items-center justify-between py-3 hover:text-mst transition-colors duration-200">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e(asset('assets/images/icons/abu.svg')); ?>" alt="Abu Dhabi Tours" class="w-6 h-6 object-contain">
                        ...
                        <a href="#" class="flex items-center justify-between py-3 hover:text-mst transition-colors duration-200">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e(asset('assets/images/icons/holiday.svg')); ?>" alt="Holiday Packages" class="w-6 h-6 object-contain">
                        ...
                        <a href="#" class="flex items-center justify-between py-3 hover:text-mst transition-colors duration-200">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e(asset('assets/images/icons/tips.svg')); ?>" alt="Tips" class="w-6 h-6 object-contain">
                ...
                <div class="popular-guide bg-gray-50 border border-gray-200 p-6 rounded-2xl">
                    ...
                    <div class="flex flex-col">
                        ...
                        <a href="#" class="flex gap-3 py-2 group">
                            <img src="<?php echo e(asset('assets/images/b1-original.webp')); ?>" alt="Complete Umrah Guide" class="w-14 h-14 rounded-lg object-cover flex-shrink-0">
                        ...
                        <!-- Guide 2 -->
                        <a href="#" class="flex gap-3 py-2 group">
                            <img src="<?php echo e(asset('assets/images/b2-original.webp')); ?>" alt="Desert Safari Guide" class="w-14 h-14 rounded-lg object-cover flex-shrink-0">
                            <div class="flex-1 flex flex-col justify-center">
                                <h4 class="font-heading font-bold text-sm text-mst-gray leading-tight">
                        ...
                        <!-- Guide 3 -->
                        <a href="#" class="flex gap-3 py-2 group">
                            <img src="<?php echo e(asset('assets/images/b3-original.webp')); ?>" alt="UAE Visa Guide" class="w-14 h-14 rounded-lg object-cover flex-shrink-0">
                            <div class="flex-1 flex flex-col justify-center">
                                <h4 class="font-heading font-bold text-sm text-mst-gray leading-tight">
                        ...
                        <!-- Guide 4 -->
                        <a href="#" class="flex gap-3 py-2 group">
                            <img src="<?php echo e(asset('assets/images/b4-original.webp')); ?>" alt="Abu Dhabi Travel Guide" class="w-14 h-14 rounded-lg object-cover flex-shrink-0">
                            <div class="flex-1 flex flex-col justify-center">
                                <h4 class="font-heading font-bold text-sm text-mst-gray leading-tight">
                        ...
                        <!-- Guide 5 -->
                        <a href="#" class="flex gap-3 py-2 group">
                            <img src="<?php echo e(asset('assets/images/b5-original.webp')); ?>" alt="Budget trip to Dubai" class="w-14 h-14 rounded-lg object-cover flex-shrink-0">
                            <div class="flex-1 flex flex-col justify-center">
                                <h4 class="font-heading font-bold text-sm text-mst-gray leading-tight">
...
<?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/frontend/pages/includes/blogs.blade.php ENDPATH**/ ?>