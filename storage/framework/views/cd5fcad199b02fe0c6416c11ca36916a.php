...
<section class="flex justify-center items-center">
    <div class="px-4 relative flex md:min-h-[850px]  min-h-[650px] w-full bg-[-250px] md:bg-center bg-cover
    bg-no-repeat umrah-hero-section"
         style="
        ...
        <div class="z-10 w-full py-10">
            <div class="container mx-auto">
                <div class="mx-auto max-w-3xl text-center pt-12 pb-10">
                    ...
                    <a href="<?php echo e(route('page.default', 'umrah-for-single-lady')); ?>"
