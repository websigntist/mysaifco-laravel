                                ...
                                <div class="row g-6 pt-5">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text"
                                               ...
                                               class="form-control"
                                               placeholder="Enter <?php echo e(_label('brand_name')); ?>..." required>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" id="editor" name="description" rows="4" placeholder="Description"><?php echo e(old('description')); ?></textarea>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" id="ordering" name="ordering" value="<?php echo e(old('ordering', 0)); ?>" class="form-control" min="0">
                                    </div>
                                    <div class="col-md-4">
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\brands\form.blade.php ENDPATH**/ ?>