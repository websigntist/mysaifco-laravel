<section class="flex justify-center items-center py-12 px-4 md:py-14">
            ...
            <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5">
                <div class="border-1 bg-gray-50 border-gray-200 rounded-2xl p-4 space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="">
                            <div class="font-heading text-md font-medium text-mst-gray">UAE</div>
                            <div class="font-body text-xs text-mst-gray capitalize">Tourist & Business visa</div>
                        </div>
...
<?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/frontend/components/global-visa.blade.php ENDPATH**/ ?>