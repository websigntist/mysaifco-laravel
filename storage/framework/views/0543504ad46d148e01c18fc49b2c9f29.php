                                        ...
                                        <div class="input-group">
                                            <div class="input-group-text">
                                                <input class="form-check-input mt-0"
                                                       ...
                                                       value="1"
                                                       id="show_title"
                                                       <?php echo e(old('show_title') ? 'checked' : ''); ?>
                                        ...
                                        <div class="form-password-toggle">
                                            <label class="form-label text-capitalize" for="meta_description">
                                                <?php echo e(_label('meta_description')); ?>
                                                               ...
                                                               placeholder="Write <?php echo e(_label('meta_description')); ?>" rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-6 pt-5">
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label text-capitalize" for="parent_id">
                                            ...
                                            <?php $__currentLoopData = $productCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($productCat->id); ?>" <?php echo e((string) old('parent_id', '0') === (string) $productCat->id ? 'selected' : ''); ?>>
                                                    <?php echo e(ucfirst($productCat->title)); ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select id="show_in_menu" name="show_in_menu" class="form-select select2">
                                            <?php $__currentLoopData = $getShowinmenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e(old($menu, $menu)); ?>">
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\product-category\form.blade.php ENDPATH**/ ?>