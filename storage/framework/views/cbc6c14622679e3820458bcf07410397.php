    ...
    <div class="row g-6 d-flex align-items-end">
        ...
        <div class="col-md-12">
            <label class="form-label text-capitalize" for="maintenance_title">
                <?php echo _label('maintenance_title'); ?>
                            ...
                            value="<?php echo e(old('maintenance_title', get_setting('maintenance_title'))); ?>"
                            class="form-control"
        ...
        <div class="col-md-12 mb-5">
            <label class="form-label text-capitalize" for="content">
                <?php echo _label('content'); ?>
                               ...
                               placeholder="Write <?php echo _label('content'); ?>" rows="5"><?php echo e(get_setting('content')); ?></textarea>
        </div>
        <!-- logo -->
        <?php echo setting_image('maintenance logo', 'm_logo'); ?>
        ...
        <div class="col-md-4">
            <label class="form-label text-capitalize" for="maintenance_mode">
                ...
                <option value="Active" <?php echo e((get_setting('maintenance_mode')) == 'Active' ? 'selected' : ''); ?>>Active
                </option>
                <option value="Inactive" <?php echo e((get_setting('maintenance_mode')) == 'Inactive' ? 'selected' : ''); ?>>
                    Inactive
                </option>
            </select>
        </div>
        ...
        <div class="col-md-4">
            <label class="form-label text-capitalize" for="show_timer">
                ...
                <option value="">-Select option-</option>
                <option value="Yes" <?php echo e((get_setting('show_timer')) == 'Yes' ? 'selected' : ''); ?>>Yes</option>
                <option value="No" <?php echo e((get_setting('show_timer')) == 'No' ? 'selected' : ''); ?>>No</option>
            </select>
        </div>
        <!-- expiry date -->
        <div class="col-md-4">
            <label class="form-label text-capitalize" for="maintenance_end_date">
                <?php echo _label('maintenance_end_date'); ?>
                            ...
                            value="<?php echo e(get_setting('maintenance_end_date')); ?>"
                            class="form-control dob-picker"
                            placeholder="YYYY-MM-DD">
        </div>
    </div>
</div>
<?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\components\maintenance_mode.blade.php ENDPATH**/ ?>