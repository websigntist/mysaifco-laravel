                                                    ...
                                                    <div class="d-flex justify-content-start align-items-center user-name">
                                                        <div class="avatar-wrapper">
                                                            <div class="avatar avatar-md me-4 light-gallery" id="gallery-<?php echo e($data->id); ?>">
                                                                <a href="<?php echo e(asset('assets/images/'.$module .'/'. $data->icon)); ?>">
                                                                    <img src="<?php echo e($data->icon ? asset('assets/images/' . $module .'/'. $data->icon) : imageNotFound()); ?>"
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <small class="text-muted">Ordering: <?php echo e($data->ordering); ?></small>
                                                        </div>
                                                    </div>
                ...
                btn.addEventListener("click", async function () {
                    ...
                    try {
                        ...
                        const iconUrl = data.icon
                            ? `/assets/images/<?php echo e($module); ?>/${data.icon}`
                            : '<?php echo e(imageNotFound()); ?>';

                        const rows = `
                            <tr><th>ID</th><td>${data.id ?? '-'}</td></tr>
                            <tr><th>Title</th><td>${data.title ?? '-'}</td></tr>
                            <tr><th>Icon</th><td><img src="${iconUrl}" alt="" class="rounded border" style="max-height:80px"></td></tr>
                            <tr>
                                <th>Status</th>
                                <td>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\red-tags\listing.blade.php ENDPATH**/ ?>