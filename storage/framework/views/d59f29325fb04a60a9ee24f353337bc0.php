<section class="">
    <div class="px-4 relative flex w-full items-start justify-center overflow-hidden">
        <div class="absolute inset-0 scale-100 bg-cover bg-top bg-no-repeat" style="background-image: url('<?php echo e(asset('assets/images/pages/1783979506_6a555df24b1af_image.webp')); ?>')" aria-hidden="true"></div>
    ...
    <div class="container mx-auto">
        ...
        lg:items-center justify-between gap-6">
            <div class="flex items-start gap-4">
                <img src="<?php echo e(asset('assets/images/icons/785.svg')); ?>" alt="">
                <div>
            ...
            <a href="#" class="inline-flex items-center justify-center gap-2 flex-shrink-0 rounded-lg px-6 py-2
                ...
                <img src="<?php echo e(asset('assets/images/icons/3656.svg')); ?>" class="brightness-0 invert" alt=""> Book an
                                                                                                           Appointment
            </a>
        </div>
    </div>
                        ...
                        <li>
                            <a href="<?php echo e($link['url']); ?>"
                               class="group flex items-center gap-3 text-mst-gray hover:text-mst transition">
                                <img src="<?php echo e(asset('assets/images/icons/' . $link['icon'])); ?>"
                                     alt="<?php echo e($link['label']); ?>">
                                <span class="font-heading text-sm font-semibold"><?php echo e($link['label']); ?></span> </a>
                        </li>
...
<section class="pt-14">
    <div class="container mx-auto">
        <div class="flex items-center gap-3 mb-3">
            <img src="<?php echo e(asset('assets/images/icons/099.svg')); ?>" alt="">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <?php $__currentLoopData = $vfsGlobalOffices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $office): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo $__env->make('frontend.pages.includes.partials.vfs-office-card', $office, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
</section>
...
<section class="pt-14">
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <?php $__currentLoopData = $tasheerOffices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $office): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo $__env->make('frontend.pages.includes.partials.vfs-office-card', $office, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-6">
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-2xl p-6 md:p-8">
                <div class="flex items-center gap-3 mb-8">
                    <img src="<?php echo e(asset('assets/images/icons/1235.svg')); ?>" class="w-7" alt="">
                    ...
                    <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="relative flex flex-col items-center text-center">
                            ...
                            items-center justify-center mt-1 mb-3 relative z-10">
                                <img src="<?php echo e(asset('assets/images/icons/' . $step['icon'])); ?>" alt="">
                            </div>
                            <h4 class="font-heading font-bold text-sm text-mst-gray leading-tight mb-1 mt-2"><?php echo $step['title']; ?></h4>
                            <p class="font-body text-xs text-gray-600 leading-snug"><?php echo e($step['desc']); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
                ...
                <ul class="space-y-3">
                    <?php $__currentLoopData = $notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="flex items-start gap-3">
                            <img src="<?php echo e(asset('assets/images/icons/006.svg')); ?>" alt="">
                            <span class="font-body text-sm text-mst-gray leading-6 -m-1"><?php echo e($note); ?></span>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-2xl p-4">
                <div class="flex items-center gap-3 mb-6">
                    <img src="<?php echo e(asset('assets/images/icons/5326.svg')); ?>" alt="">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-y-6">
                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-start gap-1">
                            <img src="<?php echo e(asset('assets/images/icons/' . $service['icon'])); ?>" alt="<?php echo e($service['label']); ?>">
                            <span class="font-heading font-semibold text-xs text-mst-gray"><?php echo $service['label']; ?></span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-2xl p-4">
                <div class="flex items-center gap-3 mb-4">
                    <img src="<?php echo e(asset('assets/images/icons/598.svg')); ?>" alt="">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-4">
                    <?php $__currentLoopData = $reasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center gap-2">
                            <img src="<?php echo e(asset('assets/images/icons/' . $reason['icon'])); ?>" alt="<?php echo e($reason['label']); ?>">
                            <span class="font-body text-sm text-mst-gray leading-tight"><?php echo e($reason['label']); ?></span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
...
<?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/frontend/pages/includes/vtf-tasheel.blade.php ENDPATH**/ ?>