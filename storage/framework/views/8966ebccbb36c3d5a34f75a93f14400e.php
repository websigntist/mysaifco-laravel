<footer class="pt-12 px-3 bg-gray-900-- border-t-3 border-t-std relative overflow-hidden">
    <div class="absolute inset-0 scale-105 bg-cover bg-center bg-no-repeat blur-[3px]"
         style="background-image: url('<?php echo e(asset('assets/images/background/bg2.webp')); ?>')" aria-hidden="true"></div>
    ...
    <div class="container mx-auto relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-5">
            <div class="">
                <a href="<?php echo e(url('/')); ?>" class="text-2xl font-bold text-gray-300 py-3">
                    <img src="<?php echo e(asset('assets/images/logo.webp')); ?>" alt="logo" title="brand logo"> </a>
                ...
                <ul class="flex gap-2 mt-1">
                    <li>
                        <a href=""> <img src="<?php echo e(asset('assets/images/icons/fb.svg')); ?>"
                                         class="w-8"
                                         alt="brand_logo"
                                         title="standard patches"> </a>
                    </li>
                    <li>
                        <a href=""> <img src="<?php echo e(asset('assets/images/icons/yt.svg')); ?>"
                                         class="w-8"
                                         alt="brand_logo"
                                         title="standard patches"> </a>
                    </li>
        ...
        <div class="md:w-12/12 mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div class="">
                    <div class="flex items-center justify-center gap-3">
                        <div class="text-white text-sm font-medium text-center space-y-[5px]">
                            <img src="<?php echo e(asset('assets/images/icons/us.png')); ?>" class="mx-auto" alt="logo" title="usa">
                ...
                <div class="">
                    <div class="flex items-center justify-center gap-3">
                        <div class="text-white text-sm font-medium text-center space-y-[5px]">
                            <img src="<?php echo e(asset('assets/images/icons/ca.png')); ?>" class="mx-auto" alt="logo" title="canada">
                ...
                <div class="">
                    <div class="flex items-center justify-center gap-3">
                        <div class="text-white text-sm font-medium text-center space-y-[5px]">
                            <img src="<?php echo e(asset('assets/images/icons/pk.png')); ?>" class="mx-auto" alt="logo" title="pakistan">
...
<?php /**PATH D:\laragon\www\laravel-cursor\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>