                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label text-capitalize" for="title">
                                            <span><?php echo e(_label('title')); ?></span> </label> <input type="text"
                                                                                             id="title"
                                                                                             name="title"
                                                                                             value="<?php echo e(old('menu_title', $data->title)); ?>"
                                                                                             class="form-control"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <input type="text"
                                                   ...
                                                   id="identifier"
                                                   name="identifier"
                                                   value="<?php echo e(old('identifier', $data->identifier)); ?>"
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\static-blocks\edit.blade.php ENDPATH**/ ?>