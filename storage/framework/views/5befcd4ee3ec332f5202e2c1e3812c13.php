                                ...
                                <div class="row g-6 pt-5">
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label text-capitalize" for="description">
                                            <span><?php echo e(_label('answer')); ?></span>
                                         </label>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/backend/faqs/form.blade.php ENDPATH**/ ?>