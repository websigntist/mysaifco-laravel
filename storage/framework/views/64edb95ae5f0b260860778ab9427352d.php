                                        ...
                                        <div class="col-md-12">
                                            <label class="form-label text-capitalize" for="meta_keywords">
                                                <?php echo e(_label('meta_keywords')); ?>
                                                            ...
                                                            id="meta_keywords"
                                                            name="meta_keywords"
                                                            value="<?php echo e($data->meta_keywords); ?>"
                                                            class="form-control"
                                            ...
                                            <div class="form-password-toggle">
                                                <label class="form-label text-capitalize" for="meta_description">
                                                    <?php echo e(_label('meta_description')); ?>
                                                                   ...
                                                                   placeholder="Write <?php echo e(_label('meta_description')); ?>" rows="3"><?php echo e($data->meta_description); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card card-action border-top-bottom">
                            ...
                            <div class="collapse show">
                                <div class="card-body">
                                    <div class="row g-6 pt-5">
                                        <div class="col-md-12">
                                            <?php echo image_input_option($data->image ? asset('assets/images/'.$module .'/' . $data->image) : imageNotFound()); ?>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select id="status" name="status" class="form-select select2" required>
                                                <?php $__currentLoopData = $getStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($status); ?>" <?php echo e(old('status', $data->status) == $status ? 'selected' : ''); ?>>
                                        ...
                                        <div class="col-md-12">
                                            <label class="form-label text-capitalize" for="blog_categories">
                                                ...
                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e(old($category->id, $category->id)); ?>"
                                                        <?php echo e(in_array($category->id, $data->blogCategories->pluck('id')->toArray()) ? 'selected' : ''); ?>>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select id="blog_tags" name="blog_tags[]" class="form-select select2" multiple>
                                                ...
                                                <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e(old($tag->id, $tag->id)); ?>"
                                                        <?php echo e(in_array($tag->id, $data->blogTags->pluck('id')->toArray()) ? 'selected' : ''); ?>>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\blogs\edit.blade.php ENDPATH**/ ?>