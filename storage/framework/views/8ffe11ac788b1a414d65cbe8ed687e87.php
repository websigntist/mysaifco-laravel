                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="<?php echo e(asset('assets/images/avatars/1.png')); ?>" alt=""
                            ...
                            <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="<?php echo e(asset('assets/images/avatars/2.png')); ?>" alt="" class="rounded-circle">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <img src="<?php echo e(asset('assets/images/users/'.currentUserimage())); ?>" alt="<?php echo e(currentUserimage()); ?>" class="rounded-circle">
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a class="dropdown-item mt-0" href="#">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="mb-0 text-capitalize"><?php echo e(currentUserFirstName()); ?>

                                        <small class="text-gray text-lowercase"> | <?php echo e(currentUserType()); ?></small>
                                    </h6>
                                    <small class="text-body-secondary"><?php echo e(currentUserEmail()); ?></small>
                                </div>
                            </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="dropdown-item" href="<?php echo e(route('users.edit',currentUserId())); ?>">
...
<?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/backend/components/top_bar.blade.php ENDPATH**/ ?>