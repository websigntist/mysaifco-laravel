                ...
                <div class="col-sm-12 col-xl-8 offset-xl-2">
                    <div class="d-flex justify-content-between align-items-center mb-3 mt-5">
                        <div class="d-flex flex-column justify-content-center">
                            <?php echo heading_breadcrumbs('Update ' . str_replace('-', ' ', $title), str_replace('-', ' ', $title) . ' edit'); ?>
                                ...
                                <div class="row g-6 pt-5">
                                    <div class="col-md-6">
                                        <label class="form-label text-capitalize" for="name">
                                                    <span><?php echo e(_label('brand_name')); ?></span> </label>
                                        <input type="text" id="title" name="name" value="<?php echo e(old('name', $data->name)); ?>" class="form-control" required><?php echo error_label('name'); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="friendly_url" name="friendly_url" value="<?php echo e(old('friendly_url', $data->friendly_url)); ?>" class="form-control">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" id="editor" name="description" rows="4"><?php echo e(old('description', $data->description)); ?></textarea>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <select id="status" name="status" class="form-select select2 text-capitalize" required>
                                            <?php $__currentLoopData = $getStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($status); ?>" <?php echo e(old('status', $data->status) === $status ? 'selected' : ''); ?>><?php echo e(ucfirst($status)); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="col-md-8">
                                        <label class="form-label" for="ordering"><?php echo e(_label('ordering')); ?></label>
                                        <input type="number" id="ordering" name="ordering" value="<?php echo e(old('ordering', $data->ordering)); ?>" class="form-control" min="0">
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label text-capitalize" for="image"><span><?php echo e(_label('image')); ?></span></label>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\brands\edit.blade.php ENDPATH**/ ?>