                    ...
                    <div class="relative">
                        ...
                        <a href=""
                           class="absolute right-5 bottom-5 inline-flex shrink-0 items-center justify-center
                            ...
                            <img src="<?php echo e(asset('assets/images/icons/line-arrow.svg')); ?>" alt="arrow" class="w-5 h-6"> </a>
                    </div>
                    <div class="relative">
            ...
            <div class="our-popular-inner">
                <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between md:gap-8">
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="mt-4 pe-20">
                            Enjoy luxury yacht charter Dubai experiences with private yacht rental, Dubai Marina
                            cruises, and views of Atlantis, Burj Al Arab, and JBR.
                        </p>
                    </div>
                ...
                <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/04.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                    ...
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/05.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                    ...
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/06.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
            ...
            <div class="our-popular-inner">
                <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between md:gap-8">
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="mt-4 pe-20">
                            Discover Dubai city tours covering Burj Khalifa views, Dubai Frame, Jumeirah Mosque, and top
                            attractions with guided sightseeing experiences.
                        </p>
                    </div>
                ...
                <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                                                    hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white
                                                    z-10 truncate max-w-[85%]">Dubai Trio (City Tour, Desert Safari
                        </div>
                        <div class="absolute left-5 bottom-14 flex gap-0.5 text-amber-400 items-center z-10"
                             aria-hidden="true">
                            <?php for($i = 0; $i < 5; $i++): ?>
                    ...
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/07.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                                                    hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white
                                                    z-10 truncate max-w-[85%]">4 Tours: Desert Safari, Dubai City
                        </div>
                        <div class="absolute left-5 bottom-14 flex gap-0.5 text-amber-400 items-center z-10"
                             aria-hidden="true">
                            <?php for($i = 0; $i < 5; $i++): ?>
            ...
            <div class="our-popular-inner">
                <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between md:gap-8">
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="mt-4 pe-20">
                            Explore Abu Dhabi tours with Sheikh Zayed Grand Mosque, Louvre Museum, city sightseeing, and
                            full-day guided tours from Dubai.
                        </p>
                    </div>
                ...
                <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/10.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                                hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white
                                z-10 truncate max-w-[85%]">Abu Dhabi City Tours
                        </div>
                        <div class="absolute left-5 bottom-14 flex gap-0.5 text-amber-400 items-center z-10"
                             aria-hidden="true">
                            <?php for($i = 0; $i < 5; $i++): ?>
                    ...
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/11.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                                                    hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white
                                                    z-10 truncate max-w-[85%]">Abu Dhabi City Tour with Louvre M..
                        </div>
                        <div class="absolute left-5 bottom-14 flex gap-0.5 text-amber-400 items-center z-10"
                             aria-hidden="true">
                            <?php for($i = 0; $i < 5; $i++): ?>
                    ...
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/12.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                                                    hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white
                                                    z-10 truncate max-w-[85%]">Abu Dhabi City Tour with Ferrari W..
                        </div>
                        <div class="absolute left-5 bottom-14 flex gap-0.5 text-amber-400 items-center z-10"
                             aria-hidden="true">
                            <?php for($i = 0; $i < 5; $i++): ?>
            ...
            <div class="our-popular-inner">
                <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between md:gap-8">
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="mt-4 pe-20">
                            Book dhow cruise Dubai with dinner, live entertainment, and scenic views of Dubai Marina or
                            Creek for a relaxing evening experience.
                        </p>
                    </div>
                ...
                <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/13.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                                hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white
                                z-10 truncate max-w-[85%]">Dhow Cruise Dinner in Dubai Marina
                        </div>
                        <div class="absolute left-5 bottom-14 flex gap-0.5 text-amber-400 items-center z-10"
                             aria-hidden="true">
                            <?php for($i = 0; $i < 5; $i++): ?>
                    ...
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/14.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                                                    hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white
                                                    z-10 truncate max-w-[85%]">Musandam Dibba Day Cruise with
                        </div>
                        <div class="absolute left-5 bottom-14 flex gap-0.5 text-amber-400 items-center z-10"
                             aria-hidden="true">
                            <?php for($i = 0; $i < 5; $i++): ?>
                    ...
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/15.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                                                    hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white
                                                    z-10 truncate max-w-[85%]">Dhow Cruise Dinner in Dubai Creek
                        </div>
                        <div class="absolute left-5 bottom-14 flex gap-0.5 text-amber-400 items-center z-10"
                             aria-hidden="true">
                            <?php for($i = 0; $i < 5; $i++): ?>
            ...
            <div class="our-popular-inner">
                <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between md:gap-8">
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="mt-4 pe-20">
                            Save more with Dubai combo tours including desert safari, city tours, dhow cruise, and Abu
                            Dhabi tours in one package.
                        </p>
                    </div>
                ...
                <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/16.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                                hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white
                                z-10 truncate max-w-[85%]">Dubai Trio (Dubai City Tour, Desert
                        </div>
                        <div class="absolute left-5 bottom-14 flex gap-0.5 text-amber-400 items-center z-10"
                             aria-hidden="true">
                            <?php for($i = 0; $i < 5; $i++): ?>
                    ...
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/17.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                    ...
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/18.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                                                    hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white
                                                    z-10 truncate max-w-[85%]">Combo 1: Dubai City Tour & Desert
                        </div>
                        <div class="absolute left-5 bottom-14 flex gap-0.5 text-amber-400 items-center z-10"
                             aria-hidden="true">
                            <?php for($i = 0; $i < 5; $i++): ?>
            ...
            <div class="our-popular-inner">
                <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between md:gap-8">
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="mt-4 pe-20">
                            Experience Dubai water activities including jet ski, parasailing, flyboarding, banana rides,
                            and exciting beach adventures across Dubai.
                        </p>
                    </div>
                ...
                <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/19.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                    ...
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/20.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                                                    hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white
                                                    z-10 truncate max-w-[85%]">Speed Boat Tour Dubai - 90 mins
                        </div>
                        <div class="absolute left-5 bottom-14 flex gap-0.5 text-amber-400 items-center z-10"
                             aria-hidden="true">
                            <?php for($i = 0; $i < 5; $i++): ?>
                    ...
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/21.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                                                    hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white
                                                    z-10 truncate max-w-[85%]">Deep Sea Fishing 4 hours Tour
                        </div>
                        <div class="absolute left-5 bottom-14 flex gap-0.5 text-amber-400 items-center z-10"
                             aria-hidden="true">
                            <?php for($i = 0; $i < 5; $i++): ?>
            ...
            <div class="our-popular-inner">
                <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between md:gap-8">
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="mt-4 pe-20">
                            Get theme park tickets for Dubai attractions including Ferrari World, IMG Worlds,
                            Motiongate, and Aquaventure water park experiences.
                        </p>
                    </div>
                ...
                <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/22.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                                hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white
                                z-10 truncate max-w-[85%]">Hot Air Balloon Tour (6 Hours)
                        </div>
                        <div class="absolute left-5 bottom-14 flex gap-0.5 text-amber-400 items-center z-10"
                             aria-hidden="true">
                            <?php for($i = 0; $i < 5; $i++): ?>
                    ...
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/23.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                                                    hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white
                                                    z-10 truncate max-w-[85%]">Wonder Bus Tour
                        </div>
                        <div class="absolute left-5 bottom-14 flex gap-0.5 text-amber-400 items-center z-10"
                             aria-hidden="true">
                            <?php for($i = 0; $i < 5; $i++): ?>
                    ...
                    <div class="relative">
                        <img src="<?php echo e(asset('assets/images/packages/24.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                                                    hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white
                                                    z-10 truncate max-w-[85%]">Bollywood Parks™ Dubai
                        </div>
                        <div class="absolute left-5 bottom-14 flex gap-0.5 text-amber-400 items-center z-10"
                             aria-hidden="true">
                            <?php for($i = 0; $i < 5; $i++): ?>
