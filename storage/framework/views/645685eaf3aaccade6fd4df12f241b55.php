...
<?php $__env->startSection('content'); ?>
    <div class="container-xxl flex-grow-1 mt-3 -container-p-y">
          <form action="<?php echo e(route('quotations.update', $getData->id)); ?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
              <?php echo csrf_field(); ?>
                            ...
                            <div class="row g-6 pt-5">
                               <div class="col-md-4">
                                  <label class="form-label text-capitalize" for="quotation_number">
                                      <span><?php echo e(_label('quotation_number')); ?></span>
                                  </label>
                                  <input type="text"
                                         id="quotation_number"
                                         name="quotation_number"
                                         value="<?php echo e(old('quotation_number', $getData->quotation_number)); ?>"
                                         class="form-control"
                                         placeholder="Quotation Number..."
                                         required>
                                   <?php echo error_label('quotation_number'); ?>
                               ...
                               <div class="col-md-6">
                                  <label class="form-label text-capitalize" for="quotation_date">
                                      <span><?php echo e(_label('quotation_date')); ?></span>
                                  </label>
                                  <input type="date"
                                         id="quotation_date"
                                         name="quotation_date"
                                         value="<?php echo e(old('quotation_date', $getData->quotation_date->format('Y-m-d'))); ?>"
                                         class="form-control dob-picker"
                                         placeholder="YYYY-MM-DD"
                                         required>
                                   <?php echo error_label('quotation_date'); ?>

                               </div>

                               <div class="col-md-6">
                                  <label class="form-label text-capitalize" for="valid_until">
                                      <span><?php echo e(_label('valid_until')); ?></span>
                                  </label>
                                  <input type="date"
                                         id="valid_until"
                                         name="valid_until"
                                         value="<?php echo e(old('valid_until', $getData->valid_until->format('Y-m-d'))); ?>"
                                         class="form-control dob-picker"
                                         placeholder="YYYY-MM-DD"
                                         required>
                                   <?php echo error_label('valid_until'); ?>
                      ...
                      <div class="collapse show">
                         <div class="card-body">
                            <div id="quotation-items-container">
                                ...
                                <div class="quotation-item border p-3 mb-3 rounded" data-item="<?php echo e($index); ?>">
                               ...
                               <div class="col-md-4">
                                  ...
                                  <?php if($getData->letterhead): ?>
                                      <div class="mb-2 position-relative d-inline-block" id="letterhead-preview">
                                          <img src="<?php echo e(asset('assets/images/quo-assets/' . $getData->letterhead)); ?>"
                                               alt="Letterhead"
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\customer-quotations\edit.blade.php ENDPATH**/ ?>