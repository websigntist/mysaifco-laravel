...
<?php $__env->startSection('content'); ?>
    <div class="container-xxl flex-grow-1 mt-3 -container-p-y">
          <form action="<?php echo e(route('invoices.store')); ?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
              <?php echo csrf_field(); ?>
             <div class="row gy-6">
                 <div class="col-sm-12">
                            ...
                            <div class="row g-6 pt-5">
                               <div class="col-md-4">
                                  ...
                                  <select class="form-select select2" id="invoice_type" name="invoice_type" required>
                                      ...
                                      <?php $__currentLoopData = $invoiceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <option value="<?php echo e($key); ?>" <?php echo e(old('invoice_type', 'sales') == $key ? 'selected' : ''); ?>>
                                              <?php echo e($type); ?>
                               ...
                               <div class="col-md-4">
                                  ...
                                  <input type="text"
                                         id="invoice_number"
                                         name="invoice_number"
                                         value="<?php echo e(old('invoice_number', $invoiceNumber)); ?>"
                                         class="form-control"
                               ...
                               <div class="col-md-4">
                                  <label class="form-label text-capitalize" for="status">
                                      <span><?php echo e(_label('invoice_status')); ?></span>
                                  </label>
                               ...
                               <div class="col-md-4">
                                  ...
                                  <select class="form-select select2" id="payment_status" name="payment_status" required>
                                      ...
                                      <?php $__currentLoopData = $paymentStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pStatus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <option value="<?php echo e($pStatus); ?>" <?php echo e(old('payment_status', 'Paid') == $pStatus ? 'selected' : ''); ?>>
                                              <?php echo e($pStatus); ?>
                               ...
                               <div class="col-md-4">
                                  ...
                                  <select class="form-select select2" id="currency" name="currency" required>
                                      ...
                                      <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $symbol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <option value="<?php echo e($code); ?>" <?php echo e(old('currency', 'AED') == $code ? 'selected' : ''); ?>>
                            ...
                            <div class="row g-6 pt-5">
                               ...
                               <div class="col-md-12">
                                  ...
                                  <textarea class="form-control"
                                            ...
                                            rows="3"><?php echo e(old('client_address')); ?></textarea>
                               </div>
                            </div>
                         </div>
                      </div>
                            ...
                            <div class="row g-6 pt-5">
                               ...
                               <div class="col-md-12">
                                  ...
                                  <textarea class="form-control"
                                            ...
                                            rows="3"><?php echo e(old('terms')); ?></textarea>
                               </div>
                            </div>
                         </div>
                      </div>
                            ...
                            <div class="row g-4">
                               ...
                               <div class="col-12">
                                  ...
                                  <input type="number"
                                         ...
                                         name="vat_rate"
                                         class="form-control"
                                         value="<?php echo e(old('vat_rate', 0)); ?>"
                                         step="0.01"
                                         min="0"
                                         max="100">
                                  <div class="d-flex justify-content-between align-items-center text-warning mt-2">
...
$(document).ready(function() {
    ...
    $('#invoice_type').on('change', function() {
        ...
        if (invoiceType) {
            ...
            $.ajax({
                url: '<?php echo e(route("invoices.create")); ?>',
                type: 'GET',
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\customer-invoices\form.blade.php ENDPATH**/ ?>