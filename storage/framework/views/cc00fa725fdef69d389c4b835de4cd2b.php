                ...
                <div class="flex justify-start">
                    <ul class="flex mt-0.5">
                        <li class="text-white text-xs flex">
                            ...
                            <span class="hidden md:block"><?php echo e(get_setting('landline_number')); ?></span>
                        </li>
...
<?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\frontend\components\top_bar.blade.php ENDPATH**/ ?>