            ...
            <div class="row mb-6 gy-6">
                                ...
                                <div class="row g-6 pt-5">
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label text-capitalize" for="slug">
                                            <span><?php echo e(_label('template_slug')); ?></span>
                                        </label>
                                        <input type="text"
                                                 id="slug"
                                                 name="slug"
                ...
                <div class="col-sm-12 col-xl-4">
                    ...
                    <div class="card card-action border-top-bottom mt-5">
                        <div class="card-header border-bottom py-3 d-flex justify-content-between align-items-center">
                            <h6 class="mb-0 text-capitalize">
                                <span class="icon-sm icon-base ti tabler-table-options iconmrgn me-1"></span>Email Tags
                            </h6>
                            <?php echo card_action_element(); ?>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\email-templates\form.blade.php ENDPATH**/ ?>