                                ...
                                <div class="row g-6 pt-5">
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label text-capitalize" for="rating">
                                            <?php echo e(_label('rating')); ?> </label>
                                        <input type="text"
                                               id="rating"
                                               name="rating"
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label text-capitalize" for="designation">
                                            <?php echo e(_label('designation')); ?> </label>
                                        <input type="text"
                                               id="designation"
                                               name="designation"
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/backend/reviews/form.blade.php ENDPATH**/ ?>