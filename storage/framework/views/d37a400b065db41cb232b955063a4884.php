                                ...
                                <div class="row g-6 pt-5">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control"
                                                  ...
                                                  rows="4"><?php echo e(old('short_description', $data->short_description)); ?></textarea>
                                    </div>
                                    <div class="col-md-12">
                                ...
                                <div class="row g-6 pt-5">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control"
                                                  ...
                                                  rows="3"><?php echo e(old('meta_description', $data->meta_description)); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row g-6 pt-5">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text"
                                               id="view_all_link"
                                               name="view_all_link"
                                               value="<?php echo e(old('view_all_link', $data->view_all_link)); ?>"
                                               class="form-control"
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/backend/tour-types/edit.blade.php ENDPATH**/ ?>