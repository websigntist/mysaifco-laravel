                                        ...
                                        <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <td class="capitalize">
                                                ...
                                                <?php elseif($col === 'module_title'): ?>
                                                    ...
                                                    <span class="invisible"><?php echo e($data->module_title); ?></span>
                                                    <input type="text"
                                                           id="module_title_<?php echo e($data->id); ?>"
                                                           name="module_title"
                                                           data-id="<?php echo e($data->id); ?>"
                                                           value="<?php echo e($data->module_title); ?>"
                                                ...
                                                <?php elseif($col === 'ordering'): ?>
                                                    ...
                                                    <input type="number"
                                                           id="ordering_<?php echo e($data->id); ?>"
                                                           name="ordering"
                                                           data-id="<?php echo e($data->id); ?>"
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\modules\listing.blade.php ENDPATH**/ ?>