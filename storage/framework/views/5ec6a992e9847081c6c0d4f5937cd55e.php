                                    ...
                                    <tr id="rowId-<?php echo e($data->id); ?>">
                                        ...
                                        <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <td class="capitalize">
                                                ...
                                                <?php elseif($col === 'search_items'): ?>
                                                    <?php
                                                        $terms = collect($data->search_items ?? [])->pluck('title')->filter();
                                                    ?>
                                                    <span class="badge bg-label-primary"><?php echo e($terms->count()); ?> terms</span>
                                                    <?php if($terms->isNotEmpty()): ?>
                                                        <small class="d-block text-muted mt-1"><?php echo e(Str::words($terms->implode(', '), 10, '...')); ?></small>
                                                    <?php endif; ?>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/backend/popular-searches/listing.blade.php ENDPATH**/ ?>