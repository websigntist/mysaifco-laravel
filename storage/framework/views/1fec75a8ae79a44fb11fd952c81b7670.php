                                ...
                                <div class="row g-6 pt-5">
                                    <div class="col-md-12">
                                        <label class="form-label text-capitalize" for="user_type">
                                            <span><?php echo e(_label('user_type')); ?></span> </label> <input type="text"
                                                                                                 id="user_type"
                                                                                                 name="user_type"
                                                                                                 value="<?php echo e(old('user_type')); ?>"
                                                                                                 class="form-control"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select id="login_type" name="login_type" class="form-select select2" required>
                                            <?php $__currentLoopData = $loginTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $login_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e(old($login_type, $login_type)); ?>"><?php echo e(ucfirst($login_type)); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="col-md-12">
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\user-types\form.blade.php ENDPATH**/ ?>