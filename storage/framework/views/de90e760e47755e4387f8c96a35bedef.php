                                    ...
                                    <div class="row g-6 pt-5">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text"
                                                 id="coupon_title"
                                                 name="coupon_title"
                                                 value="<?php echo e(old('coupon_title', $data->coupon_title)); ?>"
                                                 class="form-control"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select id="discount_type" name="discount_type" class="form-select select2" required>
                                                <?php $__currentLoopData = $gettype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e(old($type, $type)); ?>" <?php echo e($data->discount_type == $type ? 'selected' : ''); ?>>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label text-capitalize" for="discount_value">
                                                <?php echo e(_label('discount_value')); ?> </label>
                                            <input type="text"
                                                  id="discount_value"
                                                  name="discount_value"
                                                  value="<?php echo e(old('discount_value', $data->discount_value)); ?>"
                                                  class="form-control"
                                                  placeholder="Enter <?php echo e(_label('discount_value')); ?>...">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text"
                                                   id="start_date"
                                                   name="start_date"
                                                   value="<?php echo e(old('start_date', $data->start_date?->format('Y-m-d'))); ?>"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text"
                                                   id="end_date"
                                                   name="end_date"
                                                   value="<?php echo e(old('end_date', $data->end_date?->format('Y-m-d'))); ?>"
                                                   class="form-control dob-picker"
                                                   placeholder="YYYY-MM-DD">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label text-capitalize" for="usage_limit">
                                                <?php echo e(_label('usage_limit')); ?> </label>
                                            <input type="number"
                                                  id="usage_limit"
                                                  name="usage_limit"
                                                  value="<?php echo e(old('usage_limit', $data->usage_limit)); ?>"
                                                  class="form-control"
                                                  placeholder="Enter <?php echo e(_label('usage_limit')); ?>...">
                                            <?php echo error_label('usage_limit'); ?>

                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label text-capitalize" for="min_order_value">
                                                <?php echo e(_label('min_order_value')); ?> </label>
                                            <input type="number"
                                                  id="min_order_value"
                                                  name="min_order_value"
                                                  value="<?php echo e(old('min_order_value', $data->min_order_value)); ?>"
                                                  class="form-control"
                                                  placeholder="Enter <?php echo e(_label('min_order_value')); ?>...">
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\coupons\edit.blade.php ENDPATH**/ ?>