...
<?php $__env->startSection('content'); ?>
    <div class="container-xxl flex-grow-1 mt-3 -container-p-y">
          <form action="<?php echo e(route('quotations.store')); ?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
              <?php echo csrf_field(); ?>
             <div class="row gy-6">
                 <div class="col-sm-12">
                            ...
                            <div class="row g-6 pt-5">
                               <div class="col-md-4">
                                  ...
                                  <input type="text"
                                         ...
                                         value="<?php echo e(old('quotation_number', $quotationNumber)); ?>"
                                         class="form-control"
                               ...
                               <div class="col-md-6">
                                  ...
                                  <input type="date"
                                         id="quotation_date"
                                         name="quotation_date"
                                         value="<?php echo e(old('quotation_date', date('Y-m-d'))); ?>"
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\customer-quotations\form.blade.php ENDPATH**/ ?>