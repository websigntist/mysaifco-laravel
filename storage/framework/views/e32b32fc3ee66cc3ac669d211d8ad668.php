            ...
            <div class="relative mt-8 -mx-4 px-4 sm:mx-0 sm:px-0">
                <div class="swiper best-seller-swiper" id="---best-seller-swiper">
                    <div class="swiper-wrapper">
                        <?php $__currentLoopData = $best_seller_packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="swiper-slide !h-auto">
                                <article class="best-seller-card flex h-full flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                                    <a href="<?php echo e($package->frontendUrl()); ?>" class="relative block aspect-[16/10] shrink-0 overflow-hidden">
                                        <img
                                            src="<?php echo e($package->imageUrl()); ?>"
                                            alt="<?php echo e($package->image_alt); ?>"
                                            title="<?php echo e($package->image_title); ?>"
                                        ...
                                        >
                                        <?php if(($slide['badge_style'] ?? '') === 'star'): ?>
                                                <span aria-hidden="true">&#11088;</span>
                                            <?php else: ?>
                                                <span aria-hidden="true">&#128293;</span>
                                            <?php endif; ?>
                                            <?php echo e($package->redTag->title); ?>

                                    </span> </a>
                                    <div class="flex flex-1 flex-col p-4">
                                        <h2 class="font-heading text-xl leading-snug text-mst-gray line-clamp-1">
                                            <a href="<?php echo e($package->frontendUrl()); ?>" class="hover:text-mst focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-mst">
                                        ...
                                        <div class="mt-auto flex items-end justify-between gap-3 pt-4">
                                            <div>
                                                ...
                                                <p class="font-heading text-xl font-bold text-mst-gray">
                                                    <?php echo e(get_setting('shop_currency')); ?> <?php echo e(number_format($package->price, 0)); ?>

                                                    <span class="text-sm font-normal text-gray-600">/person</span>
                                                </p>
                                            </div>
                                            <a
                                                href="<?php echo e($package->frontendUrl()); ?>"
                ...
                <div class="mt-15">
                    <a href="<?php echo e(route( 'page.default', 'all-tour-categories') ?? '#'); ?>" class="flex items-center justify-center w-64 text-mst-gray text-xl px-5 py-3 rounded-full
...
<?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/frontend/components/best_seller.blade.php ENDPATH**/ ?>