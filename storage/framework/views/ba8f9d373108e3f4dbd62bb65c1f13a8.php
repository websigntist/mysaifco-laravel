<div id="accordion-flush" data-accordion="collapse"
    ...
    <h2 id="accordion-flush-heading-1">
        <button type="button" class="text-white flex items-center justify-between w-full py-5 font-medium rtl:text-right
        border-b border-white gap-3" data-accordion-target="#accordion-flush-body-1" aria-expanded="false"
    ...
    <div id="accordion-flush-body-1" class="hidden" aria-labelledby="accordion-flush-heading-1">
        <div class="py-5">
            <ul class="flex flex-col gap-1 text-gray-200 text-md capitalize space-y-[5px]">
                <li class="flex">
                    <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px"
                         fill="#FFFFFF">
                        <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/>
                    </svg>
                    <a href="<?php echo e(route('about-us')); ?>">about us</a></li>
                <li class="flex">
                    <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px"
                         fill="#FFFFFF">
                        <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/>
    ...
    <h2 id="accordion-flush-heading-2">
        <button type="button" class="text-white flex items-center justify-between w-full py-5 font-medium
        rtl:text-right border-b border-white gap-3" data-accordion-target="#accordion-flush-body-2" aria-expanded="false" aria-controls="accordion-flush-body-2">
            <span>Products</span>
            <svg data-accordion-icon class="w-5 h-5 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 15 7-7 7 7"/>
            </svg>
    ...
    <h2 id="accordion-flush-heading-3">
        <button type="button" class="text-white flex items-center justify-between w-full py-5 font-medium
        rtl:text-right border-b border-white gap-3" data-accordion-target="#accordion-flush-body-3" aria-expanded="false" aria-controls="accordion-flush-body-3">
    ...
    <h2 id="accordion-flush-heading-4">
        ...
        border-b border-white gap-3 text-white" data-accordion-target="#accordion-flush-body-4" aria-expanded="false"
                aria-controls="accordion-flush-body-3">
            <span>Popular Patches</span>
            <svg data-accordion-icon class="w-5 h-5 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 15 7-7 7 7"/>
            </svg>
        </button>
...
<?php /**PATH D:\laragon\www\laravel-cursor\resources\views/frontend/components/footer_menu.blade.php ENDPATH**/ ?>