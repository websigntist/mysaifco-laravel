...
?>
<section class="holiday-packages-section flex justify-center items-center overflow-x-clip bg-white py-10 sm:py-12
md:bg-gradient-to-r md:from-[#ffffff] md:from-50% md:to-[#E5EBFB] md:to-50% md:py-10s">
