                                            ...
                                            <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <td class="capitalize">
                                                    <?php if($col === 'image'): ?>
                                                        <div class="d-flex justify-content-start align-items-center user-name">
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                ...
                                                                </a> <small><?php echo e(Str::words(strip_tags((string) ($data->description ?? '')), 10, '...')); ?></small>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <?php elseif($col === 'price'): ?>
                                                        <?php echo e($currency . ' ' . $data->price); ?>
                ...
                `;
                    ...
                    try {
                        ...
                        const rows = `
                            ...
                            <tr><th><?php echo e(ucwords(str_replace('_',' ','tour_price'))); ?></th><td> ${data.currency} ${data.price ?? '-'} </td></tr>
                            <tr><th><?php echo e(ucwords(str_replace('_',' ','tour_title'))); ?></th><td>${data.title ?? '-'}</td></tr>
                            <tr><th><?php echo e(ucwords(str_replace('_',' ','friendly_url'))); ?></th><td>${data.friendly_url ?? '-'}</td></tr>
                            <tr><th><?php echo e(ucwords(str_replace('_',' ','tour_duration'))); ?></th><td>${data.tour_duration ?? '-'}</td></tr>
                            <tr><th><?php echo e(ucwords(str_replace('_',' ','max_persons'))); ?></th><td>${data.max_persons ?? '-'}</td></tr>
                            <tr><th><?php echo e(ucwords(str_replace('_',' ','min_age'))); ?></th><td>${data.min_age ?? '-'}</td></tr>
                            <tr><th><?php echo e(ucwords(str_replace('_',' ','description'))); ?></th><td>${data.description ?? '-'}</td></tr>
                            <tr><th><?php echo e(ucwords(str_replace('_',' ','itinerary'))); ?></th><td>${data.itinerary ?? '-'}</td></tr>
                            <tr>
                                <th><?php echo e(ucwords(str_replace('_',' ','status'))); ?></th>
                                <td>
                            ...
                            <tr><th><?php echo e(ucwords(str_replace('_',' ','ordering'))); ?></th><td>${data.ordering ?? '-'}</td></tr>
                            <tr><th><?php echo e(ucwords(str_replace('_',' ','created_at'))); ?></th><td>${data.created_at ?? '-'}</td></tr>
                            <tr><th><?php echo e(ucwords(str_replace('_',' ','created_by'))); ?></th><td>${data.created_by_name ?? '-'}</td></tr>
                            <tr>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/backend/tours/listing.blade.php ENDPATH**/ ?>