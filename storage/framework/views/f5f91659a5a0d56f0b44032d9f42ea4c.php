                    ...
                    try {
                        ...
                        const rows = `
                            ...
                            <tr>
                                ...
                                <td>
                                    <img
                                        src="${data.image ? `/assets/images/<?php echo e($module); ?>/${data.image}` :
                            imageNotFound()}"
                                        alt="Image"
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\blog-category\listing.blade.php ENDPATH**/ ?>