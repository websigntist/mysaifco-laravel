<?php $__env->startSection('content'); ?>
    ...
    <section>
        <div class="container mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 relative mt-8 -mx-4 px-4 sm:mx-0 sm:px-0">
                <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <article class="best-seller-card flex h-full flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                            ...
                            <div class="flex flex-1 flex-col p-4">
                                <h2 class="line-clamp-2">
                                    <a href="<?php echo e($slide['url']); ?>" class="hover:text-mst transition ease-in-out duration-500
                                ...
                                <div class="mt-2 flex flex-wrap items-center gap-1.5 text-xs text-gray-700
                                    ...
                                    <span class="font-body"><?php echo e($slide['rating']); ?>/5 |</span> <span><?php echo e($slide['reviews']); ?></span>
                                </div>
    ...
    <?php echo $__env->make('frontend.components.faqs_disert_safari', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('frontend.components.explore_dubai', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/frontend/pages/disert-safari-tour.blade.php ENDPATH**/ ?>