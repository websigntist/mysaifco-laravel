                ...
                <div class="col-sm-12">
                    <div class="d-flex justify-content-between align-items-center mb-3 mt-5">
                        ...
                        <div class="card-header-elements ms-auto d-flex align-content-between">
                            <?php echo goBack($_categories,'Update'); ?>
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label text-capitalize" for="parent_id">
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e(old($category->id, $category->id)); ?>" <?php echo e($category->id == $data->parent_id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\blog-category\edit.blade.php ENDPATH**/ ?>