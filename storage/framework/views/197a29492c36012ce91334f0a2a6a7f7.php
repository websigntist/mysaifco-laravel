                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label text-capitalize" for="parent_id">
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($category->id); ?>" <?php echo e((int) $category->id === (int) $data->parent_id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\product-category\edit.blade.php ENDPATH**/ ?>