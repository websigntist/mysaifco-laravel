        ...
        <div class="relative z-10 w-full">
            <div class="container mx-auto w-full">
                <div class="grid w-full grid-cols-1 md:grid-cols-2 items-center gap-5">
                    ...
                    <div class="">
                        <?php echo $__env->make('frontend.components.why_choose_carousel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/frontend/components/why_choose.blade.php ENDPATH**/ ?>