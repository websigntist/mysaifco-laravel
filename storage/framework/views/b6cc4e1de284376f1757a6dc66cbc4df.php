            ...
            <div class="container mx-auto">
                <div class="mx-auto max-w-3xl text-center pt-12 pb-10">
                   ...
                   rounded-full
                        ...
                        Connect with Us <img src="<?php echo e(asset('assets/images/icons/btn-arrow.svg')); ?>"
...
<section class="pb-12">
    <div class="container">
        <div class="mx-auto max-w-5xl text-center pt-12 pb-10">
            <h1>
                <span>Umrah </span><span class="text-mst">Umrah from</span>
            </h1>
            <p class="mt-5">Umrah Packages Compare our Umrah by Bus packages and select the accommodation option that
                            matches your travel needs and budget. From economical sharing arrangements to more private
        ...
        <div class="grid grid-cols-1 md:grid-cols-[2fr_1.5fr] items-center gap-8">
            <div>
                <h1 class="md:text-left text-center normal-case">
                    <span>Saudi tourist visa </span><span class="text-mst">(One-year multiple Entry visa)</span>
                </h1>
                <p class="text-[16px] mt-4 md:text-left text-center">Saudi Arabia has opened its doors to visitors from
                                                                     all over the world with its evisa program since
                                                                     September 2019. Visitors can get a multiple-entry
