        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 mt-14 items-center">
            ...
            <div class="faqmst">
                <div id="accordion-card" data-accordion="collapse">
                    ...
                    <h2 id="faq-1">
                        <button type="button" class="flex items-center justify-between w-full p-4 font-medium text-heading
                    ...
                    <h2 id="faq-2" class="mt-6">
                        <button type="button" class="flex items-center justify-between w-full p-4 font-medium
                        text-heading rounded-lg border border-gray-200 text-mst-gray
                         gap-3 [&[aria-expanded='true']]:rounded-b-none [&[aria-expanded='true']]:shadow-none" data-accordion-target="#faq-body-2" aria-expanded="false" aria-controls="faq-body-2">
                    ...
                    <div id="faq-body-2" class="hidden rounded-b-lg border border-gray-200"
                    ...
                    <h2 id="faq-3" class="mt-6">
                        <button type="button" class="flex items-center justify-between w-full p-4 font-medium
                                    text-heading rounded-lg border border-gray-200 text-mst-gray
                                    gap-3 [&[aria-expanded='true']]:rounded-b-none [&[aria-expanded='true']]:shadow-none" data-accordion-target="#faq-body-3" aria-expanded="false" aria-controls="faq-body-3">
                    ...
                    <div id="faq-body-3" class="hidden rounded-b-lg border border-gray-200" aria-labelledby="faq-3">
                        <div class="pb-4 pt-0 px-4">
                            <p class="mb-2 text-body text-xs text-white">Lorem ipsum dolor sit amet, consectetur
                                                                         adipisicing elit. Accusantium animi assumenda
                                                                         at consequatur cum distinctio dolor dolores
                    ...
                    <h2 id="faq-4" class="mt-6">
                        <button type="button" class="flex items-center justify-between w-full p-4 font-medium
                                text-heading rounded-lg border border-gray-200 text-mst-gray
                                gap-3 [&[aria-expanded='true']]:rounded-b-none
                    ...
                    <div id="faq-body-4" class="hidden rounded-b-lg border border-gray-200" aria-labelledby="faq-4">
                        <div class="pb-4 pt-0 px-4">
                            <p class="mb-2 text-body text-xs text-white">Lorem ipsum dolor sit amet, consectetur
                                                                         adipisicing elit. Accusantium animi assumenda
                                                                         at consequatur cum distinctio dolor dolores
                    ...
                    <div id="faq-body-5" class="hidden rounded-b-lg border border-gray-200" aria-labelledby="faq-5">
                        <div class="pb-4 pt-0 px-4">
                            <p class="mb-2 text-body text-xs text-white">Lorem ipsum dolor sit amet, consectetur
                                                                         adipisicing elit. Accusantium animi assumenda
                                                                         at consequatur cum distinctio dolor dolores
