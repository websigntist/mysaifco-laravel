                            ...
                            <div class="faqmst overflow-hidden rounded-lg border border-gray-200 bg-white transition">
                                <h2 id="faq-<?php echo e($faqNumber); ?>">
                                    <button type="button"
                                        ...
                                        <svg data-accordion-icon class="h-5 w-5 shrink-0 transition-transform duration-300 <?php echo e($isFirst ? 'rotate-180' : ''); ?>" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <div id="faq-body-<?php echo e($faqNumber); ?>"
                                     ...
                                     style="grid-template-rows: <?php echo e($isFirst ? '1fr' : '0fr'); ?>;"
                                     aria-labelledby="faq-<?php echo e($faqNumber); ?>">
                                    <div class="overflow-hidden">
                                        <div class="px-5 pb-5">
                                            <p class="font-body text-sm leading-relaxed text-white"><?php echo e($faq->description); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
