                                                    ...
                                                    <?php if($col === 'image'): ?>
                                                        <div class="avatar avatar-sm">
                                                            <a href="<?php echo e(asset('assets/images/'.$module .'/'. $data->image)); ?>"
                                                               ...
                                                               data-title="<?php echo e($data->image); ?>">
                ...
                `;
                    ...
                    try {
                        ...
                        const rows = `
                            ...
                            <tr><th><?php echo e(ucwords(str_replace('_',' ','tour_price'))); ?></th><td>${data.price ?? '-'}</td></tr>
                            ...
                            <tr><th>T<?php echo e(ucwords(str_replace('_',' ','tour_duration'))); ?></th><td>${data.tour_duration ?? '-'}</td></tr>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\laravel-cursor\resources\views/backend/tours/listing.blade.php ENDPATH**/ ?>