        ...
        <div class="grid grid-cols-1 md:grid-cols-[8fr_4fr] gap-6">
            ...
            <div class="leftSide__column">
                ...
                <div class="text-sm text-mst-gray font-heading mb-2 flex items-center gap-1.5 select-none">
                    <a href="<?php echo e(url('/')); ?>" class="hover:text-mst transition">Home</a>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-5 gap-4 mt-6 border-t border-gray-200 py-5">
                    ...
                    <div class="flex items-center gap-2.5">
                        <div class="flex items-center justify-center flex-shrink-0">
                            <img src="<?php echo e(asset('assets/images/icons/tag.svg')); ?>" class="object-contain" alt="">
                        </div>
                        <div>
                    ...
                    <div class="flex items-center gap-2.5">
                        <div class="flex items-center justify-center flex-shrink-0">
                            <img src="<?php echo e(asset('assets/images/icons/redpin.svg')); ?>" class="object-contain" alt="">
                        </div>
                        <div>
                    ...
                    <div class="flex items-center gap-2.5">
                        <div class="flex items-center justify-center flex-shrink-0">
                            <img src="<?php echo e(asset('assets/images/icons/3dclock.svg')); ?>" class="object-contain" alt="">
                        </div>
                        <div>
                    ...
                    <div class="flex items-center gap-2.5">
                        <div class="flex items-center justify-center flex-shrink-0">
                            <img src="<?php echo e(asset('assets/images/icons/gr3.svg')); ?>" class="object-contain" alt="">
                        </div>
                        <div>
                    ...
                    <div class="flex items-center gap-2.5">
                        <div class="flex items-center justify-center flex-shrink-0">
                            <img src="<?php echo e(asset('assets/images/icons/min-age.svg')); ?>" class="object-contain"
                                 alt="">
                        </div>
                        <div>
                        ...
                        <div class="relative">
                            <div class="w-full flex items-center justify-between border border-gray-200 rounded-xl px-4 py-3 text-mst-gray cursor-pointer" onclick="const input = document.getElementById('booking-tour-time'); input.type='time'; try { input.showPicker(); } catch(e) { input.focus(); }">
                                <div class="flex items-center gap-2.5 w-full">
                                    ...
                                    <img src="<?php echo e(asset('assets/images/icons/3dclock.svg')); ?>" class="object-contain flex-shrink-0 pointer-events-none" alt="">
    ...
    <div class="container mx-auto">
        <div class="our-popular-inner">
            ...
            <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5">
                <div class="relative">
                    <img src="<?php echo e(asset('assets/images/tours/1779654952_6a136128093c9_image.webp')); ?>" class="rounded-lg w-full h-full min-h-[280px] object-cover" alt="4
                    tours
                    desert
                ...
                <div class="relative">
                    <img src="<?php echo e(asset('assets/images/tours/1779654998_6a136156a0cf2_image.webp')); ?>" class="rounded-lg w-full h-full min-h-[280px] object-cover" alt="combo 1 dubai city tour and desert safari">
                    <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80 hover:bg-black/20 transition duration-300 ease-in-out"></div>
                    <div class="absolute left-5 bottom-20 font-heading text-xl font-normal text-white z-10 truncate max-w-[85%]">
                ...
                <div class="relative">
                    <img src="<?php echo e(asset('assets/images/tours/1779655014_6a136166191e8_image.webp')); ?>" class="rounded-lg w-full h-full min-h-[280px] object-cover"
                         alt="combo 3
                    desert
...
<?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views/frontend/pages/single-tour-details.blade.php ENDPATH**/ ?>