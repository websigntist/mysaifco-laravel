                ...
                <div class="grid grid-cols-2 md:grid-cols-5 mt-10 gap-6 md:gap-0 md:divide-x md:divide-gray-200">
                    ...
                    <div class="flex flex-col items-center text-center px-1">
                        <div class="w-10 h-10 flex items-center justify-center mb-3">
                            <img src="<?php echo e(asset('assets/images/icons/4543534.svg')); ?>" alt="">
                        </div>
                    ...
                    <div class="flex flex-col items-center text-center px-1">
                        <div class="w-10 h-10 flex items-center justify-center mb-3">
                            <img src="<?php echo e(asset('assets/images/icons/17years.svg')); ?>" alt="">
                        </div>
                    ...
                    <div class="flex flex-col items-center text-center px-1">
                        <div class="w-10 h-10 flex items-center justify-center mb-3">
                            <img src="<?php echo e(asset('assets/images/icons/6786.svg')); ?>" alt="">
                        </div>
                    ...
                    <div class="flex flex-col items-center text-center px-1">
                        <div class="w-10 h-10 flex items-center justify-center mb-3">
                            <img src="<?php echo e(asset('assets/images/icons/8789.svg')); ?>" alt="">
                        </div>
                    ...
                    <div class="flex flex-col items-center text-center px-1">
                        <div class="w-10 h-10 flex items-center justify-center mb-3">
                            <img src="<?php echo e(asset('assets/images/icons/support2.svg')); ?>" alt="">
                        </div>
                ...
                <div class="flex">
                    ...
                    <div class="flex-1 space-y-3 w-full">
                        ...
                        <div class="flex items-center gap-4">
                            <img src="<?php echo e(asset('assets/images/icons/563455.svg')); ?>" class="w-10 h-10" alt="">
                            <span class="font-body font-semibold text-sm text-mst-gray">Established since 2008</span>
                        </div>
                        <!-- Benefit 2 -->
                        <div class="flex items-center gap-4">
                            <img src="<?php echo e(asset('assets/images/icons/0256.svg')); ?>" class="w-10 h-10" alt="">
                            <span class="font-body font-semibold text-sm text-mst-gray">Licensed Dubai Travel Company</span>
                        </div>
                        <!-- Benefit 3 -->
                        <div class="flex items-center gap-4">
                            <img src="<?php echo e(asset('assets/images/icons/06565.svg')); ?>" class="w-10 h-10" alt="">
                            <span class="font-body font-semibold text-sm text-mst-gray">Thousands of happy Customers</span>
                        </div>
                        <!-- Benefit 4 -->
                        <div class="flex items-center gap-4">
                            <img src="<?php echo e(asset('assets/images/icons/870.svg')); ?>" class="w-10 h-10" alt="">
                            <span class="font-body font-semibold text-sm text-mst-gray">Secure Online Booking</span>
                        </div>
                        <!-- Benefit 5 -->
                        <div class="flex items-center gap-4">
                            <img src="<?php echo e(asset('assets/images/icons/980.svg')); ?>" class="w-10 h-10" alt="">
                            <span class="font-body font-semibold text-sm text-mst-gray">Professional Tour Guides</span>
                        </div>
                        <!-- Benefit 6 -->
                        <div class="flex items-center gap-4">
                            <img src="<?php echo e(asset('assets/images/icons/890.svg')); ?>" class="w-10 h-10" alt="">
                    ...
                    <div class="w-full md:w-[260px] lg:w-[320px] flex-shrink-0 flex justify-center items-center pt-8 md:pt-0">
                        <img src="<?php echo e(asset('assets/images/image 2444-original.webp')); ?>" alt="Travel Gear"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <div class="border border-gray-200 rounded-2xl overflow-hidden flex flex-col h-full relative group">
                <div class="relative w-full h-[180px] overflow-hidden">
                    <img src="<?php echo e(asset('assets/images/75a83f469853919410b9476bf7279b57a0ddb912-original.webp')); ?>" alt="UAE Tours" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                </div>
                <!-- Floating icon badge -->
                <div class="absolute top-[156px] left-12 -translate-x-1/2 w-12 h-12 rounded-full bg-[#03174C] flex
                items-center justify-center  z-10">
                    <img src="<?php echo e(asset('assets/images/icons/4324.svg')); ?>" alt="UAE Tours Icon" class="w-6 h-6 object-contain">
                </div>
            ...
            <div class="border border-gray-200 rounded-2xl overflow-hidden flex flex-col h-full relative group">
                <div class="relative w-full h-[180px] overflow-hidden">
                    <img src="<?php echo e(asset('assets/images/6bd7d38372ae03ba24c615c77580229b3c275cc5-original.webp')); ?>" alt="UAE Tours" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                </div>
                <!-- Floating icon badge -->
                <div class="absolute top-[156px] left-12 -translate-x-1/2 w-12 h-12 rounded-full bg-[#03174C] flex
                            items-center justify-center  z-10">
            ...
            <div class="border border-gray-200 rounded-2xl overflow-hidden flex flex-col h-full relative group">
                <div class="relative w-full h-[180px] overflow-hidden">
                    <img src="<?php echo e(asset('assets/images/a795af09aed7660cdcf4f16278b49649a23cef19-original.webp')); ?>" alt="UAE Tours" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                </div>
                <!-- Floating icon badge -->
                <div class="absolute top-[156px] left-12 -translate-x-1/2 w-12 h-12 rounded-full bg-[#03174C] flex
                            items-center justify-center  z-10">
                    <img src="<?php echo e(asset('assets/images/icons/4234.svg')); ?>" alt="UAE Tours Icon" class="w-6 h-6 object-contain">
                </div>
                <div class="p-6 pt-10 flex flex-col flex-1 bg-white">
            ...
            <div class="border border-gray-200 rounded-2xl overflow-hidden flex flex-col h-full relative group">
                <div class="relative w-full h-[180px] overflow-hidden">
                    <img src="<?php echo e(asset('assets/images/5ca35a590ea25fd4c7d15380a4b12247102182b1-original.webp')); ?>" alt="UAE Tours" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                </div>
                <!-- Floating icon badge -->
                <div class="absolute top-[156px] left-12 -translate-x-1/2 w-12 h-12 rounded-full bg-[#03174C] flex
                            items-center justify-center  z-10">
                    <img src="<?php echo e(asset('assets/images/icons/247visa.svg')); ?>" alt="UAE Tours Icon" class="w-6 h-6 object-contain">
                </div>
                <div class="p-6 pt-10 flex flex-col flex-1 bg-white">
            ...
            <div class="border border-gray-200 rounded-2xl overflow-hidden flex flex-col h-full relative group">
                <div class="relative w-full h-[180px] overflow-hidden">
                    <img src="<?php echo e(asset('assets/images/1b1d882cb5f802e1f2727ebd1dc0a66191a5f708-original.webp')); ?>" alt="UAE Tours" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                </div>
                <!-- Floating icon badge -->
                <div class="absolute top-[156px] left-12 -translate-x-1/2 w-12 h-12 rounded-full bg-[#03174C] flex
                            items-center justify-center  z-10">
                    <img src="<?php echo e(asset('assets/images/icons/4533.svg')); ?>" alt="UAE Tours Icon" class="w-6 h-6 object-contain">
                </div>
                <div class="p-6 pt-10 flex flex-col flex-1 bg-white">
            ...
            <div class="lg:col-span-6 flex rounded-2xl overflow-hidden flex-col sm:flex-row h-full">
                ...
                <div class="flex-1 bg-[#03174C] p-4 flex items-center justify-center gap-4">
                    <div class="flex items-center justify-center gap-3">
                        <img src="<?php echo e(asset('assets/images/icons/6506.svg')); ?>"
                             class="w-30 h-30"
                             alt="">
                    </div>
                    <div>
                ...
                <div class="flex-1 bg-[#F09B25] p-4 flex items-center justify-center gap-4">
                    <div class="flex items-center justify-center gap-3">
                        <img src="<?php echo e(asset('assets/images/icons/0986.svg')); ?>"
                             class="w-30 h-30"
                             alt="">
                    </div>
                    <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div class="lg:col-span-6 flex flex-col md:flex-row gap-6 items-center md:items-start">
                ...
                <div class="relative flex-shrink-0">
                    <img src="<?php echo e(asset('assets/images/md-msg.png')); ?>" alt="Asim Rehman" class="w-full h-full rounded-full object-cover">
                </div>
                <div class="flex-1">
                    <!-- Quote Mark icon -->
                    <img src="<?php echo e(asset('assets/images/icons/quote.svg')); ?>"
            ...
            <div class="lg:col-span-6 grid grid-cols-1 md:grid-cols-[1.9fr_1.9fr_1.7fr] gap-4">
                ...
                <div class="p-5 rounded-3xl border border-gray-200 flex flex-col justify-between h-60">
                    <div class="space-y-3">
                        <!-- Top header -->
                        <img src="<?php echo e(asset('assets/images/icons/grating.svg')); ?>"
                             class="w-full"
                             alt="">
                ...
                <div class="p-5 rounded-3xl border border-gray-200 flex flex-col justify-between h-60">
                    <div class="space-y-3">
                        <!-- Top header -->
                        <img src="<?php echo e(asset('assets/images/icons/triprating.svg')); ?>"
                             class="w-full"
                             alt="">
                ...
                <div class="bg-[#03174C] p-5 rounded-3xl text-white text-center flex flex-col justify-between h-60">
                    ...
                    <!-- Stars -->
                    <img src="<?php echo e(asset('assets/images/icons/stars1.svg')); ?>"
                         class="w-full h-full"
                         alt="">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-6 lg:gap-8 w-full lg:w-auto justify-center lg:justify-end">
                ...
                <a href="#"
                   ...
                   class="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#2D9D3E] to-[#1E5E28] px-8 py-3.5 rounded-full text-white font-heading font-bold italic text-base md:text-lg shadow-md hover:shadow-lg transition-all duration-300 w-full sm:w-auto group">
                    <img src="<?php echo e(asset('assets/images/icons/whatsapp1.svg')); ?>" alt="">
                ...
                <div class="flex items-center gap-4 w-full sm:w-auto justify-center sm:justify-start">
                    <a href="#" class="flex items-center justify-center flex-shrink-0">
                        <img src="<?php echo e(asset('assets/images/icons/phone1.svg')); ?>"
                             class=""
                             alt="">
                    </a>
                    <div class="text-left">
