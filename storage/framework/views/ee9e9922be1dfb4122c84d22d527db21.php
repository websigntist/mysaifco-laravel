                                ...
                                <div class="card-body">
                                    <div class="row g-6 pt-5">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text" id="friendlyUrl"><?php echo e(siteUrl()); ?>/</span>
                                                <input type="text"
                                                       class="form-control"
                                                       id="friendly_url"
                                                       name="friendly_url"
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="description" class="form-control" id="editor"><?php echo e(old('description')); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row g-6 pt-5">
                                        ...
                                        <div class="col-md-12">
                                            <label class="form-label text-capitalize" for="blog_categories">
                                                <?php echo e(_label('categories')); ?>

                                            </label> <select id="blog_categories" name="blog_categories[]" class="form-select select2" multiple>
                                                <option value="0">/Parent</option>
                                                <?php $__currentLoopData = $blogCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blogCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e(old($blogCat->id, $blogCat->id)); ?>">
                                                        <?php echo e(ucfirst ($blogCat->title)); ?>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select id="blog_tags" name="blog_tags[]" class="form-select select2" multiple>
                                                ...
                                                <?php $__currentLoopData = $blogTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blogtag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e(old($blogtag->id, $blogtag->id)); ?>">
                                                        <?php echo e(ucfirst ($blogtag->title)); ?>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select id="show_in_menu" name="show_in_menu" class="form-select select2">
                                                <?php $__currentLoopData = $getShowinmenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($menu); ?>"><?php echo e(ucfirst($menu)); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="col-md-12">
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\blogs\form.blade.php ENDPATH**/ ?>