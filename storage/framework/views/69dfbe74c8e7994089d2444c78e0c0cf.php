       ...
       <div class="container-xxl flex-grow-1 mt-3 -container-p-y">
          <form action="<?php echo e(route('setting.update-form')); ?>" method="post" enctype="multipart/form-data">
              ...
              <input type="hidden" name="active_tab" id="active_tab"
                     value="<?php echo e(old('active_tab', session('active_tab', '#general_setting'))); ?>">
                               ...
                               <div class="col-md-12 sitesettings">
                                  <div class="nav-align-left nav-tabs-shadow">
                                     ...
                                     <div class="tab-content">
                                        ...
                                        <?php echo $__env->make('backend.components.unit_currency', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\settings\edit.blade.php ENDPATH**/ ?>