        ...
        <div class="our-popular-inner">
            <div class="our-popular-header flex flex-col gap-5 md:flex-row md:items-start md:justify-between md:gap-8">
                <div class="min-w-0 flex-1">
                    <h2 class="font-heading text-2xl sm:text-3xl font-semibold italic leading-tight tracking-tight text-mst-gray">
            ...
            <div class="our-popular-grid mt-8 grid grid-cols-1 gap-4 sm:gap-5 md:mt-10 md:grid-cols-3 md:gap-5">
                <?php $__currentLoopData = $popularCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <a href="<?php echo e($category['url']); ?>" class="our-popular-card__link">
                            <img
                                src="<?php echo e(asset('assets/images/' . $category['image'])); ?>"
    ...
    <div class="container mx-auto">
        <div class="our-popular-inner">
            ...
            <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5">
                <div class="relative">
                    <a href="javascript:">
                        <img src="<?php echo e(asset('assets/images/product-category/01.webp')); ?>"
                        ...
                        <div class="absolute left-5 bottom-8 font-heading text-xl font-medium text-white z-10">Dubai Safari Tour</div>
                        <div class="absolute left-5 bottom-3 font-body text-xs text-white/70 z-10">15 Tours</div>
                    </a>
                </div>
                <div class="relative col-span-2">
                    <a href="javascript:">
                        <img src="<?php echo e(asset('assets/images/product-category/02.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                        hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-8 font-heading text-xl font-medium text-white z-10">Yacht Charter</div>
                        <div class="absolute left-5 bottom-3 font-body text-xs text-white/70 z-10">21 Tours</div>
                    </a>
                </div>
                <div class="relative">
                    <a href="javascript:">
                        <img src="<?php echo e(asset('assets/images/product-category/03.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                        hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-8 font-heading text-xl font-medium text-white z-10">Abu Dhabi Tours </div>
                        <div class="absolute left-5 bottom-3 font-body text-xs text-white/70 z-10">5 Tours</div>
                    </a>
                </div>
                <div class="relative">
                    <a href="javascript:">
                        <img src="<?php echo e(asset('assets/images/product-category/04.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                        hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-8 font-heading text-xl font-medium text-white z-10">Dhow Cruise Tours</div>
                        <div class="absolute left-5 bottom-3 font-body text-xs text-white/70 z-10">4 Tours</div>
                    </a>
                </div>
                <div class="relative">
                    <a href="javascript:">
                        <img src="<?php echo e(asset('assets/images/product-category/05.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                        hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-8 font-heading text-xl font-medium text-white z-10">Dubai City Tour</div>
                        <div class="absolute left-5 bottom-3 font-body text-xs text-white/70 z-10">5 Tours</div>
                    </a>
                </div>
                <div class="relative">
                    <a href="javascript:">
                        <img src="<?php echo e(asset('assets/images/product-category/06.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                        hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-8 font-heading text-xl font-medium text-white z-10">Dubai Combo Tours</div>
                        <div class="absolute left-5 bottom-3 font-body text-xs text-white/70 z-10">7 Tours</div>
                    </a>
                </div>
                <div class="relative">
                    <a href="javascript:">
                        <img src="<?php echo e(asset('assets/images/product-category/07.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                        hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-8 font-heading text-xl font-medium text-white z-10">Water Activities</div>
                        <div class="absolute left-5 bottom-3 font-body text-xs text-white/70 z-10">5 Tours</div>
                    </a>
                </div>
                <div class="relative">
                    <a href="javascript:">
                        <img src="<?php echo e(asset('assets/images/product-category/08.webp')); ?>"
                             class="rounded-lg w-full h-full object-cover"
                             alt="img">
                        <!-- Overlay -->
                        <div class="absolute inset-0 rounded-lg bg-gradient-to-b from-transparent to-black/80
                        hover:bg-black/20 transition duration-300 ease-in-out"></div>
                        <div class="absolute left-5 bottom-8 font-heading text-xl font-medium text-white z-10">Theme Park Tickets</div>
                        <div class="absolute left-5 bottom-3 font-body text-xs text-white/70 z-10">10 Tours</div>
                    </a>
                </div>
            </div>
        </div>
