                                                    ...
                                                    <div class="d-flex justify-content-start align-items-center user-name">
                                                        <div class="avatar-wrapper">
                                                            <div class="avatar avatar-md me-4 light-gallery" id="gallery-<?php echo e($data->id); ?>">
                                                                <a href="<?php echo e(asset('assets/images/'.$imageFolder .'/'. $data->image)); ?>">
                                                                    <img src="<?php echo e($data->image ? asset ('assets/images/' . $imageFolder .'/'. $data->image) : imageNotFound()); ?>"
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <a href="javascript:" class="text-heading text-truncate">
                                                                <span class="fw-medium"><?php echo e($data->first_name); ?></span>
                                                            </a> <small><?php echo e($data->email); ?></small>
                                                        </div>
                                                    </div>
                                                <?php elseif($col === 'user_type'): ?>
                                                    <span class="text-heading">
                                                        <?php echo e($data->userType?->user_type ?? 'N/A'); ?>
                ...
                `;
                    ...
                    try {
                        ...
                        const imageUrl = data.image
                            ? `/assets/images/<?php echo e($imageFolder); ?>/${data.image}`
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\mysaifco-laravel\resources\views\backend\customers\listing.blade.php ENDPATH**/ ?>