...
return new class extends Migration
{
    ...
    {
        $existing = DB::table('modules')->where('module_slug', 'vaccination-centers')->first();
        ...
        if ($existing) {
            ...
            $data = [
                'parent_id'    => 0,
                'module_title' => 'Vaccination Centers',
                'module_slug'  => 'vaccination-centers',
                'actions'      => self::ACTIONS,
                'status'       => 'Active',
                'ordering'     => $maxOrder + 1,
                'created_by'   => 1,
    ...
    {
        $module = DB::table('modules')->where('module_slug', 'vaccination-centers')->first();
        if ($module) {
