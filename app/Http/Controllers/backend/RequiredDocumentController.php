...
use App\Models\backend\RequiredDocument;
...
class RequiredDocumentController
{
    ...
    public function __construct()
    {
        ...
        $this->table = RequiredDocument::class;
        $this->module = 'required-documents';
        $this->notify_title = 'Required Document';
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('backend.' . $this->module . '.form', [
            'title'            => $moduleTitle,
            'module'           => $this->module,
            'getStatus'        => getEnumValues('required_documents', 'status'),
    ...
    public function duplicate($id)
    {
        ...
        $dbdata = ($this->table)::create([
            ...
            'image'          => $newImage,
            'document_items' => $source->document_items,
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            Log::error('RequiredDocument update failed: ' . $e->getMessage());
    ...
    public function modalView($id)
    {
        ...
        $items = is_array($dbdata->document_items) ? $dbdata->document_items : [];
    ...
    {
        $rawItems = $request->input('required-document-items', []);
