...
class pageController
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $dataToStore = [
                ...
                'show_contact_us'  => $request->has('show_contact_us') ? 1 : 0,
                'show_whatsapp'    => $request->has('show_whatsapp') ? 1 : 0,
                'show_email_us'    => $request->has('show_email_us') ? 1 : 0,
                'show_trust_bar'   => $request->has('show_trust_bar') ? 1 : 0,
    ...
    public function duplicate($id)
    {
        ...
        $page = ($this->table)::create([
            ...
            'short_details'    => $source->short_details,
            'description'      => $source->description,
            'status'           => $source->status,
            'show_contact_us'  => $source->show_contact_us,
            'show_whatsapp'    => $source->show_whatsapp,
            'show_email_us'    => $source->show_email_us,
            'show_trust_bar'   => $source->show_trust_bar,
