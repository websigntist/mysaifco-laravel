...
class RelatedServiceController
{
    protected $userId;
    protected $table;
    protected $module;
    ...
    public function __construct()
    {
        ...
        $this->table = RelatedService::class;
        $this->module = 'related-services';
        $this->notify_title = 'Related Service';
    }
    ...
    public function index(Request $request)
    {
        ...
        $getData = ($this->table)::orderBy('ordering', 'asc')->orderBy('id', 'asc')->get();
        $columns = [
            'image',
            'title',
            'tour_type',
    ...
    public function create(Request $request)
    {
        ...
        return view('backend.' . $this->module . '.form', [
            'title'            => $moduleTitle,
            'module'           => $this->module,
            'getStatus'        => getEnumValues('related_services', 'status'),
    ...
    public function store(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            $request->validate([
                ...
                'tour_type_ids'   => 'nullable|array',
                'tour_type_ids.*' => 'exists:tour_types,id',
            ]);
    ...
    public function duplicate($id)
    {
        ...
        $dbdata = ($this->table)::create([
            ...
            'image'         => $newImage,
            'page_link'     => $source->page_link,
            'tour_type_ids' => $source->tour_type_ids,
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            Log::error('RelatedService update failed: ' . $e->getMessage());
    ...
    public function modalView($id)
    {
        ...
        $ids = is_array($dbdata->tour_type_ids) ? $dbdata->tour_type_ids : (json_decode($dbdata->tour_type_ids ?? '[]', true) ?: []);
        $tourTypeTitles = TourType::whereIn('id', (array)$ids)->pluck('title')->implode(', ');
        ...
        return response()->json([
            ...
            'image'           => $imageUrl,
            'page_link'       => $dbdata->page_link,
            'tour_type'       => !empty($tourTypeTitles) ? $tourTypeTitles : '—',
    ...
    private function payloadFromRequest(Request $request): array
    {
        return [
            ...
            'tour_type_ids' => $request->tour_type_ids ? array_values((array) $request->tour_type_ids) : null,
